<template>
    <div class="flex w-full flex-wrap pt-10 pb-10 sm:flex-nowrap items-center">
        ...
        <div class="mx-auto w-full lg:w-2/5">
            <div class="flex justify-center sm:justify-end">
                <div class="grid mb-3 w-52">
                    <button type="button"
                        ...
                        data-bs-toggle="modal" data-bs-target="#exampleModalCenter">探测器模型参数</button>
                </div>
            </div>

            <div class="flex justify-center sm:justify-end">
                <div class="grid mb-3 w-52">
                    <label for="exampleFormControlInput1" class="form-label inline-block text-gray-700">核素选择</label>
                    <select
            ...
            <div class="flex justify-center sm:justify-end">
                <div class="grid mb-3 w-52">
                    <label for="exampleFormControlInput1" class="form-label inline-block text-gray-700">发射粒子数</label>
                    <input v-model="particleNumber" type="text"
                        class="form-control block w-full px-3 py-1.5 text-base font-normal text-gray-700 bg-white bg-clip-padding border border-solid border-gray-300 rounded transition ease-in-out m-0 focus:text-gray-700 focus:bg-white focus:border-blue-600 focus:outline-none"
                        id="exampleFormControlInput1" placeholder :onChange="numberValid" />
                </div>
            </div>

            <div class="flex justify-center sm:justify-end">
                <div class="flex justify-between w-52">
                    <button :disable="disabled" @click="createGDML"
                        class="inline-block px-6 py-2.5 bg-blue-600 text-white font-medium text-xs leading-tight uppercase rounded shadow-md hover:bg-blue-700 hover:shadow-lg focus:bg-blue-700 focus:shadow-lg focus:outline-none focus:ring-0 active:bg-blue-800 active:shadow-lg transition duration-150 ease-in-out">
                        {{
                            refreshButton
                        }}
                    </button>
                    <button :disable="disabled" @click="simulation"
                        class="inline-block px-6 py-2.5 bg-blue-600 text-white font-medium text-xs leading-tight uppercase rounded shadow-md hover:bg-blue-700 hover:shadow-lg focus:bg-blue-700 focus:shadow-lg focus:outline-none focus:ring-0 active:bg-blue-800 active:shadow-lg transition duration-150 ease-in-out">
                        {{
                            LunchButton
                        }}
            ...
            <div
                ...
                <div class="modal-body relative p-4">
                    <div class="flex justify-center">
                        <div class="mb-3 w-52">
                            <label for="exampleFormControlInput1"
                                class="form-label inline-block text-gray-700">晶体高度(cm)</label>
                            <input v-model="cylinderH" type="text"
                                class="form-control block w-full px-3 py-1.5 text-base font-normal text-gray-700 bg-white bg-clip-padding border border-solid border-gray-300 rounded transition ease-in-out m-0 focus:text-gray-700 focus:bg-white focus:border-blue-600 focus:outline-none"
                                id="exampleFormControlInput1" placeholder="单位cm" />
                        </div>
                    </div>
                    ...
                    <div class="flex justify-center">
                        <div class="grid mb-3 w-52">
                            <label for="exampleFormControlInput1"
                                class="form-label inline-block text-gray-700">晶体半径(cm)</label>
                            <input v-model="cylinderR" type="text"
                                class="form-control block w-full px-3 py-1.5 text-base font-normal text-gray-700 bg-white bg-clip-padding border border-solid border-gray-300 rounded transition ease-in-out m-0 focus:text-gray-700 focus:bg-white focus:border-blue-600 focus:outline-none"
                                id="exampleFormControlInput1" placeholder="单位cm" />
                        </div>
                    </div>
                    ...
                    <div class="flex justify-center">
                        <div class="grid mb-3 w-52">
                            <label for="exampleFormControlInput1"
                                class="form-label inline-block text-gray-700">反射层顶部厚度(cm)</label>
                            <input v-model="reflectTT" type="text"
                                class="form-control block w-full px-3 py-1.5 text-base font-normal text-gray-700 bg-white bg-clip-padding border border-solid border-gray-300 rounded transition ease-in-out m-0 focus:text-gray-700 focus:bg-white focus:border-blue-600 focus:outline-none"
                                id="exampleFormControlInput1" placeholder="单位cm" />
                        </div>
                    </div>
                    ...
                    <div class="flex justify-center">
                        <div class="grid mb-3 w-52">
                            <label for="exampleFormControlInput1"
                                class="form-label inline-block text-gray-700">反射层侧面厚度(cm)</label>
                            <input v-model="reflectST" type="text"
                                class="form-control block w-full px-3 py-1.5 text-base font-normal text-gray-700 bg-white bg-clip-padding border border-solid border-gray-300 rounded transition ease-in-out m-0 focus:text-gray-700 focus:bg-white focus:border-blue-600 focus:outline-none"
                                id="exampleFormControlInput1" placeholder="单位cm" />
                        </div>
                    </div>
                    ...
                    <div class="flex justify-center">
                        <div class="grid mb-3 w-52">
                            <label for="exampleFormControlInput1"
                                class="form-label inline-block text-gray-700">反射层材料</label>
                            <select
                ...
                <div
                    ...
                    <button type="button"
                        class="inline-block px-6 py-2.5 bg-blue-600 text-white font-medium text-xs leading-tight uppercase rounded shadow-md hover:bg-blue-700 hover:shadow-lg focus:bg-blue-700 focus:shadow-lg focus:outline-none focus:ring-0 active:bg-blue-800 active:shadow-lg transition duration-150 ease-in-out ml-1">恢复默认参数</button>
                </div>
            </div>
        </div>
    </div>
    ...
    <div v-if="specFile" class="flex w-full flex-wrap sm:flex-nowrap items-center border-t pt-10">
        ...
        <div class="mx-auto w-full lg:w-2/5">
            <div class="flex justify-center sm:justify-end">
                <div class="mb-3 w-52">
                    <label for="exampleFormControlInput1" class="form-label inline-block text-gray-700">a:</label>
                    <input v-model="fa" type="text"
                        class="form-control block w-full px-3 py-1.5 text-base font-normal text-gray-700 bg-white bg-clip-padding border border-solid border-gray-300 rounded transition ease-in-out m-0 focus:text-gray-700 focus:bg-white focus:border-blue-600 focus:outline-none"
                        id="exampleFormControlInput1" placeholder="系数fa" />
                </div>
            </div>

            <div class="flex justify-center sm:justify-end">
                <div class="mb-3 w-52">
                    <label for="exampleFormControlInput1" class="form-label inline-block text-gray-700">b:</label>
                    <input v-model="fb" type="text"
                        class="form-control block w-full px-3 py-1.5 text-base font-normal text-gray-700 bg-white bg-clip-padding border border-solid border-gray-300 rounded transition ease-in-out m-0 focus:text-gray-700 focus:bg-white focus:border-blue-600 focus:outline-none"
                        id="exampleFormControlInput1" placeholder="系数fb" />
                </div>
            </div>

            <div class="flex justify-center sm:justify-end">
                <div class="mb-3 w-52">
                    <label for="exampleFormControlInput1" class="form-label inline-block text-gray-700">c:</label>
                    <input v-model="fc" type="text"
                        class="form-control block w-full px-3 py-1.5 text-base font-normal text-gray-700 bg-white bg-clip-padding border border-solid border-gray-300 rounded transition ease-in-out m-0 focus:text-gray-700 focus:bg-white focus:border-blue-600 focus:outline-none"
                        id="exampleFormControlInput1" placeholder="系数fc" />
                </div>
            </div>

            <div class="flex justify-center sm:justify-end">
                <div class="flex justify-between w-52">
                    <button :disable="disabled" @click="fwhm"
                        class="inline-block px-6 py-2.5 bg-blue-600 text-white font-medium text-xs leading-tight uppercase rounded shadow-md hover:bg-blue-700 hover:shadow-lg focus:bg-blue-700 focus:shadow-lg focus:outline-none focus:ring-0 active:bg-blue-800 active:shadow-lg transition duration-150 ease-in-out">
                        {{
                            fwhmBtn
                        }}
                    </button>
                    <button :disable="disabled" @click="originSpec"
                        class="inline-block px-6 py-2.5 bg-blue-600 text-white font-medium text-xs leading-tight uppercase rounded shadow-md hover:bg-blue-700 hover:shadow-lg focus:bg-blue-700 focus:shadow-lg focus:outline-none focus:ring-0 active:bg-blue-800 active:shadow-lg transition duration-150 ease-in-out">查看原谱</button>
                </div>
            </div>
        </div>
    </div>
