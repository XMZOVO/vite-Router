...
(c="dump"),e={expr:c,branch:d},f=d.$tree;else{if("player"===e||!e||"string"==typeof e&&0==e.indexOf("player:"))return JSROOT.require("jq2d").then(function(){JSROOT.createTreePlayer(a);a.configureTree(f);a.Show();return a});"string"===typeof e&&(e={expr:e})}if(!f)return console.error("No TTree object available for TTree::Draw"),null;JSROOT.cleanup(b);var h=0,q,m=function(c,d){if(e.player)2===h&&(g=a.drawid);else var g=b;if(g)return JSROOT.redraw(g,c);if(1===h)return d?null:new Promise(function(b){q=
b});h=1;return JSROOT.require("jq2d").then(function(){JSROOT.createTreePlayer(a);a.configureTree(f);a.Show(e);h=2;return JSROOT.redraw(a.drawid,c).then(function(b){a.setItemName("TreePlayer");q&&q(b);return b})})};e.progress=function(b){return m(b,!0)};return f.Draw(e).then(function(b){return m(b)})};JSROOT.TSelector=h;JSROOT.TDrawVariable=r;JSROOT.TDrawSelector=e;b.TTreeMethods={Process:function(a,d){function c(a,c){switch(a._typename){case "TLeafF":var d=b.kFloat;break;case "TLeafD":d=b.kDouble;
break;case "TLeafO":d=b.kBool;break;case "TLeafB":d=a.fIsUnsigned?b.kUChar:b.kChar;break;case "TLeafS":d=a.fIsUnsigned?b.kUShort:b.kShort;break;case "TLeafI":d=a.fIsUnsigned?b.kUInt:b.kInt;break;case "TLeafL":d=a.fIsUnsigned?b.kULong64:b.kLong64;break;case "TLeafC":d=b.kTString;break;default:return null}return b.createStreamerElement(c||a.fName,d)}function e(b){for(var a=0;a<g.arr.length;++a)if(g.arr[a].branch===b)return g.arr[a];return null}function f(a,h,l,m){function q(b,c,d){if(!b||!b.arr.length)return!0;
var e=a.fName;"."===e[e.length-1]&&(e=e.substr(0,e.length-1));"string"===typeof m&&"."==m[0]&&(e+=m);e+=".";for(var k=0;k<b.arr.length;++k){var p=b.arr[k];if(!(0<d&&p.fType!==d))if(p.fType===JSROOT.BranchType.kBaseClassNode){if(!q(p.fBranches,c,d))return!1}else{var n=F(p,g.file);if(n&&"BASE"===n.fTypeName){if(p.fTotBytes&&!f(p,h,l,m)||!q(p.fBranches,c,d))return!1}else{n=p.fName;var v=1;if(0===p.fName.indexOf(e))n=n.substr(e.length);else if(0<d)continue;var B=n.indexOf("[");0<B&&(n=n.substr(0,B));
B=n.indexOf("<");0<B&&(n=n.substr(0,B));0<d&&(v="$child$",B=n.indexOf("."),0<B&&(v=L(b,a.fName+"."+n.substr(0,B+1),k)||"TObject"));if(!f(p,c,n,v))return!1}}}return!0}"string"===typeof a&&(a=g.tree.FindBranch(a));if(!a)return console.error("Did not found branch"),null;var p=e(a);if(p)return console.error("Branch already configured for reading",a.fName),p.tgt!==h&&console.error("Target object differs"),null;if(!a.fEntries)return console.warn("Branch ",a.fName," does not have entries"),null;for(p={branch:a,
tgt:h,name:l,index:-1,member:null,type:0,curr_entry:-1,raw:null,basket:null,curr_basket:0,read_entry:-1,staged_entry:-1,first_readentry:-1,staged_basket:0,numentries:a.fEntries,numbaskets:a.fWriteBasket,counters:null,ascounter:[],baskets:[],staged_prev:0,staged_now:0,progress_showtm:0,GetBasketEntry:function(a){if(!this.branch||a>this.branch.fMaxBaskets)return 0;var b=a<this.branch.fMaxBaskets?this.branch.fBasketEntry[a]:0;return b?b:(b=0<a?this.branch.fBaskets.arr[a-1]:null)?this.branch.fBasketEntry[a-
1]+b.fNevBuf:0},GetTarget:function(a){if(!this.tgt)return a;for(var b=0;b<this.tgt.length;++b){var c=this.tgt[b];a[c.name]||(a[c.name]=c.lst.Create());a=a[c.name]}return a},GetEntry:function(a){a-=this.first_entry;this.branch.TestBit(b.BranchBits.kDoNotUseBufferMap)||this.raw.clearObjectMap();if(this.basket.fEntryOffset){var c=this.basket.fEntryOffset[a];this.basket.fDisplacement&&(this.raw.fDisplacement=this.basket.fDisplacement[a])}else c=this.basket.fKeylen+this.basket.fNevBufSize*a;this.raw.locate(c-
this.raw.raw_shift)}};p.GetBasketEntry(p.numbaskets+1);)p.numbaskets++;var n=a.fLeaves?a.fLeaves.arr.length:0,w=0<n?a.fLeaves.arr[0]:null,v=null,k=null,E="TBranchElement"===a._typename,J=0,u=null,r=null,x="";if(a.fBranchCount){(u=e(a.fBranchCount))||(u=f(a.fBranchCount,h,"$counter"+t++,!0));if(!u)return console.error("Cannot add counter branch",a.fBranchCount.fName),null;x=a.fBranchCount2;if(!x&&a.fBranchCount.fStreamerType===b.kSTL&&(a.fStreamerType===b.kStreamLoop||a.fStreamerType===b.kOffsetL+
b.kStreamLoop)){var K=F(a,g.file),I=a.fBranchCount.fBranches.arr;if(K&&K.fCountName&&I)for(var y=0;y<I.length;++y)if(I[y].fName===a.fBranchCount.fName+"."+K.fCountName){x=I[y];break}x||console.error("Did not found branch for second counter of kStreamLoop element")}if(x&&((r=e(x))||(r=f(x,h,"$counter"+t++,!0)),!r))return console.error("Cannot add counter branch2",x.fName),null}else if(1===n&&w&&w.fLeafCount&&(x=g.tree.FindBranch(w.fLeafCount.fName))&&((u=e(x))||(u=f(x,h,"$counter"+t++,!0)),!u))return console.error("Cannot add counter branch",
x.fName),null;if("TBranchObject"===a._typename)k={name:l,typename:a.fClassName,virtual:w.fVirtual,func:function(a,b){var c=this.typename;this.virtual&&(c=a.readFastString(a.ntou1()+1));b[this.name]=a.classStreamer({},c)}};else if(a.fType===JSROOT.BranchType.kClonesNode||a.fType===JSROOT.BranchType.kSTLNode){if(v=b.createStreamerElement(l,b.kInt),!m||"string"===typeof m&&"."===m[0]||1===m){g.process_arrays=!1;k={name:l,conttype:a.fClonesName||"TObject",reallocate:d.reallocate_objects,func:function(a,
b){a=a.ntoi4();var c=0,d=b[this.name];!d||this.reallocate?d=b[this.name]=Array(a):(c=d.length,d.length=a);for(;c<a;)d[c++]=this.methods.Create()}};if("string"===typeof m&&"."===m[0]&&(k.conttype=L(a.fBranches,a.fName+m),!k.conttype))return console.error("Cannot select object",m,"in the branch",a.fName),null;k.methods=G(k.conttype);J=a.fType===JSROOT.BranchType.kClonesNode?JSROOT.BranchType.kClonesMemberNode:JSROOT.BranchType.kSTLMemberNode}}else{if(x=A(a,g.tree)){if(!0===m)return console.warn("Object branch "+
x+" can not have data to be read directly"),null;g.process_arrays=!1;v=Array(h?h.length+1:1);for(k=0;k<v.length-1;++k)v[k]=h[k];v[v.length-1]={name:l,lst:G(x)};return q(a.fBranches,v,0)?p:null}if(E&&1===n&&w.fName===a.fName&&-1==a.fID)v=b.createStreamerElement(l,a.fClassName),v.fType===b.kAny&&((n=g.file.getStreamer(a.fClassName,{val:a.fClassVersion,checksum:a.fCheckSum}))?k={name:l,typename:a.fClassName,streamer:n,func:function(a,b){for(var c={_typename:this.typename},d=0;d<this.streamer.length;++d)this.streamer[d].func(a,
c);b[this.name]=c}}:(v=null,console.warn("not found streamer!")));else if(E&&1>=n)v=F(a,g.file),!v&&a.fStreamerType&&20>a.fStreamerType&&(v=b.createStreamerElement(l,a.fStreamerType));else if(1===n)v=c(w,l);else if("TBranch"===a._typename&&1<n){w=Array(n);E=!0;for(x=0;x<n;++x)w[x]=c(a.fLeaves.arr[x]),w[x]=b.createMember(w[x],g.file),w[x]||(E=!1);E&&(k={name:l,leaves:w,func:function(a,b){var c=b[this.name],d=0;for(c||(b[this.name]=c={});d<this.leaves.length;)this.leaves[d++].func(a,c)}})}}if(!v&&!k)return console.warn("Not supported branch kind",
