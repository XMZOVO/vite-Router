...
kPalette:JSROOT.BIT(16),kNoExponent:JSROOT.BIT(17),kLabelsHori:JSROOT.BIT(18),kLabelsVert:JSROOT.BIT(19),kLabelsDown:JSROOT.BIT(20),kLabelsUp:JSROOT.BIT(21),kIsInteger:JSROOT.BIT(22),kMoreLogLabels:JSROOT.BIT(23),kOppositeTitle:JSROOT.BIT(32)};n.prototype=Object.create(JSROOT.AxisBasePainter.prototype);n.prototype.getAxisType=function(){return"TAxis"};n.prototype.configureAxis=function(a,b,c,d,g,l,v,p){var e=this;this.name=a;this.full_min=b;this.full_max=c;this.kind="normal";this.vertical=l;this.log=
p.log||0;this.symlog=p.symlog||!1;this.reverse=p.reverse||!1;this.swap_side=p.swap_side||!1;a=this.getObject();p.time_scale||a.fTimeDisplay?(this.kind="time",this.timeoffset=f.getTimeOffset(a)):this.kind=a.fLabels?"labels":"normal";if("time"==this.kind)this.func=h.scaleTime().domain([this.convertDate(d),this.convertDate(g)]);else if(this.log){this.logbase=2===this.log?2:10;0>=g&&(g=1);if(0>=d&&a&&!p.logcheckmin)for(b=0;b<a.fNbins&&!(d=Math.max(d,a.GetBinLowEdge(b+1)),0<d);++b);0>=d&&p.log_min_nz&&
(d=p.log_min_nz);if(0>=d||d>=g)d=g*(p.logminfactor||1E-4);this.func=h.scaleLog().base(2==this.log?2:10).domain([d,g])}else this.symlog?(p=Math.max(Math.abs(d),Math.abs(g)),p=Number.isInteger(this.symlog)&&0<this.symlog?p*Math.pow(10,-1*this.symlog):.01*p,this.func=h.scaleSymlog().constant(p).domain([d,g])):this.func=h.scaleLinear().domain([d,g]);this.vertical^this.reverse&&(p=v[0],v[0]=v[1],v[1]=p);this.func.range(v);this.scale_min=d;this.scale_max=g;this.gr="time"==this.kind?function(a){return e.func(e.convertDate(a))}:
...
function(a){a=parseFloat(a);var b=this.getObject();this.regular_labels||(a=(a-b.fXmin)/(b.fXmax-b.fXmin)*b.fNbins);a=Math.floor(a);if(0>a||a>=b.fNbins)return null;for(var c=0;c<b.fLabels.arr.length;++c){var d=b.fLabels.arr[c];if(d.fUniqueID===a+1)return d.fString}return null};n.prototype.createTicks=function(a,b,c,d){c&&this.nticks&&"normal"==this.kind&&(this.noticksopt=!0);c={nminor:0,nmiddle:0,nmajor:0,func:this.func};if("labels"!=this.kind||this.regular_labels)var g=this.produceTicks(this.nticks);
else{g=[];c.lbl_pos=[];for(var l=this.getObject(),v=0;v<l.fNbins;++v){var p=l.fXmin+v/l.fNbins*(l.fXmax-l.fXmin);p>=this.scale_min&&p<this.scale_max&&(c.lbl_pos.push(p),p>this.scale_min&&g.push(p))}}c.minor=c.middle=c.major=g;if(a)return d=c.major,c=1E-5*(this.scale_max-this.scale_min),d[0]>this.scale_min+c&&d.unshift(this.scale_min),d[d.length-1]<this.scale_max-c&&d.push(this.scale_max),d;1<this.nticks2&&(!this.log||10===this.logbase)&&((c.minor=c.middle=this.produceTicks(c.major.length,this.nticks2),
a=Math.abs(this.func.range()[1]-this.func.range()[0]),c.middle.length<=c.major.length||c.middle.length>a/3.5)?c.minor=c.middle=c.major:1<this.nticks3&&!this.log&&(c.minor=this.produceTicks(c.middle.length,this.nticks3),c.minor.length<=c.middle.length||c.minor.length>a/1.7)&&(c.minor=c.middle));c.reset=function(){this.nminor=this.nmiddle=this.nmajor=0};c.next=function(a){if(this.nminor>=this.minor.length)return!1;this.tick=this.minor[this.nminor++];this.grpos=this.func(this.tick);a&&(this.grpos=Math.round(this.grpos));
this.kind=3;this.nmiddle<this.middle.length&&1>Math.abs(this.grpos-this.func(this.middle[this.nmiddle]))&&(this.nmiddle++,this.kind=2);this.nmajor<this.major.length&&1>Math.abs(this.grpos-this.func(this.major[this.nmajor]))&&(this.nmajor++,this.kind=1);return!0};c.last_major=function(){return 1!==this.kind?!1:this.nmajor==this.major.length};c.next_major_grpos=function(){return this.nmajor>=this.major.length?null:this.func(this.major[this.nmajor])};this.ndig=this.order=0;if("normal"==this.kind&&!this.log&&
0<c.major.length){l=a=0;g=!1;if(!b){b=Math.max(Math.abs(c.major[0]),Math.abs(c.major[c.major.length-1]));v=Math.min(Math.abs(c.major[0]),Math.abs(c.major[c.major.length-1]));p=0<b?3*Math.round(Math.log10(b)/3):0;var e=0<v?3*Math.round(Math.log10(v)/3):0;g=2E4>b;if(b||v)a=Math.max(p,e)+3,l=Math.min(p,e)-3}b=0;v=this.ndig;for(p=1E10;l<=a;l+=3)if(!g||3!==l){this.order=l;this.ndig=0;e=[];for(var t=0,f=0;t<c.major.length;){var h=this.format(c.major[t],!0);if(0>e.indexOf(h))e.push(h),f+=h.length,t++;else{if(15<
++this.ndig)break;e=[];f=t=0}}!l&&4>this.ndig&&(f-=2*c.major.length+3);f<p&&(p=f,b=this.order,v=this.ndig)}this.order=b;this.ndig=v;d&&(this.order&&console.warn("Axis painter - integer labels are configured, but axis order "+this.order+" is preferable"),this.ndig&&console.warn("Axis painter - integer labels are configured, but "+this.ndig+" decimal digits are required"),this.order=this.ndig=0)}return c};n.prototype.isCenteredLabels=function(){if("labels"===this.kind)return!0;if(this.log)return!1;
var a=this.getObject();return a&&a.TestBit(JSROOT.EAxisBits.kCenterLabels)};n.prototype.addTitleDrag=function(a,b,c,d,g){var l=this;if(JSROOT.settings.MoveResize&&!JSROOT.batch_mode){var v=null,p,e,t,f,u,q,r,k=h.drag().subject(Object);k.on("start",function(c){c.sourceEvent.preventDefault();c.sourceEvent.stopPropagation();c=a.node().getBBox();var N=l.getObject(),h=b?c.height:c.width,k=N.TestBit(JSROOT.EAxisBits.kOppositeTitle);t=p=a.property("shift_x");f=e=a.property("shift_y");u=b?0<p:0<e;q=b?[g,
g/2,0]:[0,g/2,g];h=b?-h/2:h/2;"middle"==l.title_align?(q[0]+=h,q[2]-=h):"begin"==l.title_align?(q[1]-=h,q[2]-=2*h):(q[0]+=2*h,q[1]+=h);r=N.TestBit(JSROOT.EAxisBits.kCenterTitle)?1:d^k?0:2;q[r]=b?e:p;v=a.append("rect").classed("zoom",!0).attr("x",c.x).attr("y",c.y).attr("width",c.width).attr("height",c.height).style("cursor","move")}).on("drag",function(c){if(v){c.sourceEvent.preventDefault();c.sourceEvent.stopPropagation();p+=c.dx;e+=c.dy;var d;var g=b?e:p;c=0;for(d=1;3>d;++d)Math.abs(g-q[d])<Math.abs(g-
q[c])&&(c=d);b?(g=p,d=q[c]):(d=e,g=q[c]);u===(b?0<g:0<d)&&(t=g,f=d,r=c,a.attr("transform","translate("+t+","+f+")"))}}).on("end",function(d){if(v){d.sourceEvent.preventDefault();d.sourceEvent.stopPropagation();a.property("shift_x",t).property("shift_y",f);var g=l.getObject();d=JSROOT.EAxisBits;var p=function(a,b){g.TestBit(a)!=b&&g.InvertBit(a)};g.fTitleOffset=(b?t:f)/c;1==r?(p(d.kCenterTitle,!0),p(d.kOppositeTitle,!1)):0==r?(p(d.kCenterTitle,!1),p(d.kOppositeTitle,!0)):(p(d.kCenterTitle,!1),p(d.kOppositeTitle,
!1));v.remove();v=null}});a.style("cursor","move").call(k)}};n.prototype.drawTicks=function(a,b,c,d,g,l,v){var p="",e="",f=0,h=0;for(this.ticks=[];b.next(!0);){var u=Math.round(d/4);3>b.kind&&(u=Math.round(d/2));1==b.kind&&(null!==this.format(b.tick,!0)&&(u=d),this.ticks.push(b.grpos));if(0<g)var q=-u;else 0>c?(q=-u,u=0):q=0;0==p.length?(p=this.vertical?"M"+u+","+b.grpos:"M"+b.grpos+","+-u,e=this.vertical?"M"+(l-u)+","+b.grpos:"M"+b.grpos+","+(l+u)):(p+=this.vertical?"m"+(u-h)+","+(b.grpos-f):"m"+
(b.grpos-f)+","+(h-u),e+=this.vertical?"m"+(h-u)+","+(b.grpos-f):"m"+(b.grpos-f)+","+(u-h));p+=this.vertical?"h"+(q-u):"v"+(u-q);e+=this.vertical?"h"+(u-q):"v"+(q-u);f=b.grpos;h=q}0<p.length&&v&&a.append("svg:path").attr("d",p).call(this.lineatt.func);0!==l&&0<e.length&&v&&a.append("svg:path").attr("d",e).call(this.lineatt.func)};n.prototype.findLabelModifier=function(a,b,c){if(!a.fModLabs)return null;for(var d=0;d<a.fModLabs.arr.length;++d){var g=a.fModLabs.arr[d];if(g.fLabNum===b+1||0>g.fLabNum&&
b===c+g.fLabNum)return g}return null};n.prototype.drawLabels=function(a,b,c,d,g,l,v,p,e,f,k){function t(a){var b=this.result_width;G=Math.max(G,b);if(b&&(!a.vertical&&!m||a.vertical&&m)&&!a.log){var c=.45*this.gap_before+.45*this.gap_after;this.gap_before?this.gap_after||(c=.9*this.gap_before):c=.9*this.gap_after;n=Math.min(n,c/b)}else a.vertical&&k&&this.normal_side&&20<k-p&&b>k-p&&(n=Math.min(n,(k-p)/b));.01<n&&.7>n&&!a.vertical&&!m&&5<w&&1==y.length&&(C=!0);b=n*(C?3:1);.01<b&&1>b&&(z=1/b,a.scaleTextDrawing(z,
y[0]))}var q=this,N=this.getColor(b.fLabelColor),V=this.isCenteredLabels(),m=b.TestBit(JSROOT.EAxisBits.kLabelsVert),n=1,w=0,z=0,y=[a.append("svg:g").attr("class","axis_labels")];g=g.lbl_pos||g.major;var C=!1,G=0;this.lbls_both_sides&&y.push(a.append("svg:g").attr("class","axis_labels").attr("transform",this.vertical?"translate("+c+",0)":"translate(0,"+-d+")"));var B=new JSROOT.FontHandler(b.fLabelFont,v);for(a=0;a<y.length;++a){0<a&&(l=-l);var I=0,E=this.vertical?-p*l:(p+2)*l+f*e;this.startTextDrawing(B,
"font",y[a]);for(var F=0;F<g.length;++F){var M=this.format(g[F],!0);if(null!==M){var D=this.findLabelModifier(b,F,g.length);if(!D||0!=D.fTextSize){D&&D.fLabText&&(M=D.fLabText);var x={text:M,color:N,latex:1,draw_g:y[a],normal_side:0==a},A=Math.round(this.func(g[F]));D&&0<D.fTextColor&&(x.color=this.getColor(D.fTextColor));x.gap_before=0<F?Math.abs(Math.round(A-this.func(g[F-1]))):0;x.gap_after=F<g.length-1?Math.abs(Math.round(this.func(g[F+1])-A)):0;if(V&&(D=x.gap_after||x.gap_before,A=Math.round(A-
(this.vertical?.5*D:-.5*D)),-5>A||A>(this.vertical?d:c)+5))continue;w=Math.max(w,M.length);this.vertical?(x.x=E,x.y=A,x.align=m?0>l?23:20:0>l?12:32):(x.x=A,x.y=E,x.align=m?0>l?12:32:0>l?20:23);m&&(x.rotate=270);0==a&&(x.post_process=t);this.drawText(x);I&&A!=I&&(this.vertical&&!m||!this.vertical&&m)&&(n=Math.min(n,.9*Math.abs(A-I)/v));I=A}}}this.order&&this.drawText({color:N,x:this.vertical?5*l:c+5,y:this.has_obstacle?E:this.vertical?-3:-3*l,align:this.vertical?0>l?30:10:this.has_obstacle^0>l?13:
10,latex:1,text:"#times"+this.formatExp(10,this.order),draw_g:y[a]})}return this.finishTextDrawing(y[0]).then(function(){return 1<y.length?(z&&q.scaleTextDrawing(z,y[1]),q.finishTextDrawing(y[1])):!0}).then(function(){C&&y[0].selectAll("text").each(function(){var a=h.select(this),b=a.attr("transform");a.attr("transform",b+" rotate(25)").style("text-anchor","start")});B&&(v=B.size);return[v,G]})};n.prototype.drawAxis=function(a,b,c,d,g,l,v,p){var e=this,f=this.getObject(),h="",k=f&&"TGaxis"===f._typename,
q=a,r=.03,m,n=!0,w=(m=this.getPadPainter())?m.getPadWidth():10,B=m?m.getPadHeight():10,z=this.vertical,y=this.swap_side||!1;g?this.invert_side&&(g=-g):g=0;k?(this.createAttLine({attr:f}),n=0!=f.fLineColor,h=f.fChopt,r=f.fTickSize,m=z?1.7*c:.6*b):(this.createAttLine({color:f.fAxisColor,width:1,style:1}),h=z^this.invert_side?"-S":"+S",r=f.fTickLength,m=z?w:B);this.lineatt.not_standard=!0;k&&"zaxis"!==this.name||(q=a.select("."+this.name+"_container"),q.empty()?q=a.append("svg:g").attr("class",this.name+
"_container"):q.selectAll("*").remove());!l&&n&&q.append("svg:path").attr("d","M0,0"+(z?"v"+c:"h"+b)).call(this.lineatt.func);q.attr("transform",d||null);var C=1;a=0;var G=Math.min(w,B),E=0<=h.indexOf("+"),I=0<=h.indexOf("-"),K=0<=h.indexOf("S");d=0<=h.indexOf("U")||this.optionUnlab;var F=0<=h.indexOf("N");h=0<=h.indexOf("I");var M=f.TestBit(JSROOT.EAxisBits.kNoExponent);0>=G&&(G=1E-4);k&&f.TestBit(JSROOT.EAxisBits.kTickPlus)&&(E=!0);k&&f.TestBit(JSROOT.EAxisBits.kTickMinus)&&(I=!0);E&&I?a=C=1:I?
C=y^z?1:-1:E&&(C=y^z?-1:1);r=Math.round((K?r:.03)*m);this.max_tick_size&&r>this.max_tick_size&&(r=this.max_tick_size);m=this.createTicks(!1,M,F,h);this.drawTicks(q,m,C,r,a,g,n&&!l&&!this.disable_ticks);g=Math.round(1>f.fLabelSize?f.fLabelSize*G:f.fLabelSize);var D=Math.round(Math.abs(f.fLabelOffset)*G);if(0>=g||1.1<Math.abs(f.fLabelOffset))d=!0;var x=0,A=0,H=null,L=null,O=0,J=0;return(l||d?Promise.resolve([g,0]):this.drawLabels(q,f,b,c,m,C,g,D,r,a,v)).then(function(a){J=a[1];if(JSROOT.settings.Zooming&&
!e.disable_zooming&&!JSROOT.batch_mode){var d=a[0];a=q.append("svg:rect").attr("class","axis_zoom").style("opacity","0").style("cursor","crosshair");z?(d=(J||2*d)+3,a.attr("x",0<C?-d:0).attr("y",0).attr("width",d).attr("height",c)):a.attr("x",0).attr("y",0<C?0:-d-3).attr("width",b).attr("height",d+3)}e.position=0;if(p){a=q.node();d=e.getPadSvg().node();if(a&&d&&a.getBoundingClientRect&&d.getBoundingClientRect){var g=a.getBoundingClientRect(),v=d.getBoundingClientRect();e.position=g.left-v.left}a&&
!d&&console.warn("Why PAD element missing when search for position")}if(!f.fTitle||l)return!0;H=q.append("svg:g").attr("class","axis_title");O=1<=f.fTitleSize?f.fTitleSize:Math.round(f.fTitleSize*G);a=1.6*(1>f.fTitleSize?f.fTitleSize:f.fTitleSize/(G||10));d=f.TestBit(JSROOT.EAxisBits.kCenterTitle);var h=f.TestBit(JSROOT.EAxisBits.kOppositeTitle);g=f.TestBit(JSROOT.EAxisBits.kRotateTitle)?-1:1;v=e.getColor(k?f.fTextColor:f.fTitleColor);e.startTextDrawing(f.fTitleFont,O,H);h^=y;e.title_align=d?"middle":
0>g^h?"begin":"end";if(z){a*=-C*w;x=Math.round(a*f.fTitleOffset);if("zaxis"==e.name&&k&&"getBoundingClientRect"in q.node()){var t=q.node().getBoundingClientRect();x<t.width-r&&(x=Math.round(t.width-r))}A=Math.round(d?c/2:h?c:0);e.drawText({align:e.title_align+";middle",rotate:0>g?90:270,text:f.fTitle,color:v,draw_g:H})}else a*=C*B,x=Math.round(d?b/2:h?0:b),A=Math.round(a*f.fTitleOffset),e.drawText({align:e.title_align+";middle",rotate:0>g?180:0,text:f.fTitle,color:v,draw_g:H});z&&0==f.fTitleOffset&&
"getBoundingClientRect"in q.node()&&(L=q.node().getBoundingClientRect());e.addTitleDrag(H,z,a,y,z?c:b);return e.finishTextDrawing(H)}).then(function(){if(H){if(L){var a=H.node().getBoundingClientRect();x=L.left!=L.right&&a.left!=a.right?0<C?Math.round(L.left-a.right-.3*O):Math.round(L.right-a.left+.3*O):-1*Math.round((0<C?D+J:0)+.7*O)}H.attr("transform","translate("+x+","+A+")").property("shift_x",x).property("shift_y",A)}return e})};n.prototype.convertTo=function(a){var b=this.getObject(),c=this.axisToSvg("x",
b.fX1),d=this.axisToSvg("y",b.fY1),g=this.axisToSvg("x",b.fX2),l=this.axisToSvg("y",b.fY2);if("ndc"==a){a=this.getPadPainter().getPadWidth();var e=this.getPadPainter().getPadHeight();b.fX1=c/a;b.fX2=g/a;b.fY1=(e-d)/e;b.fY2=(e-l)/e;this.use_ndc=!0}else"frame"==a&&(a=this.getFramePainter().getFrameRect(),b.fX1=(c-a.x)/a.width,b.fX2=(g-a.x)/a.width,b.fY1=(d-a.y)/a.height,b.fY2=(l-a.y)/a.height,this.bind_frame=!0)};n.prototype.redraw=function(){var a=this.getObject();if(this.bind_frame){var b=this.getFramePainter().getFrameRect();
var c=Math.round(b.x+a.fX1*b.width);var d=Math.round(b.x+a.fX2*b.width);var g=Math.round(b.y+a.fY1*b.height);b=Math.round(b.y+a.fY2*b.height)}else c=this.axisToSvg("x",a.fX1,this.use_ndc),g=this.axisToSvg("y",a.fY1,this.use_ndc),d=this.axisToSvg("x",a.fX2,this.use_ndc),b=this.axisToSvg("y",a.fY2,this.use_ndc);var l=d-c,e=g-b,p=Math.abs(l)<Math.abs(e),f=p?e:l,h=!1,k=a.fWmin,u=a.fWmax;0>f&&(h=!0,f=-f,p?b=g:c=d);this.configureAxis(p?"yaxis":"xaxis",k,u,k,u,p,[0,f],{time_scale:0<=a.fChopt.indexOf("t"),
log:0<=a.fChopt.indexOf("G")?1:0,reverse:h,swap_side:h});this.createG();return this.drawAxis(this.getG(),Math.abs(l),Math.abs(e),"translate("+c+","+b+")")};var J=function(a,b){var c=Math.PI/180;a=a/2*c;b*=c;var d=Math.sqrt(2),g=2*d/Math.PI,l=Math.cos(b),e=Math.sqrt(1+l*Math.cos(a));return{x:l*Math.sin(a)*2*d/e/g/c,y:Math.sin(b)*d/e/g/c}},T=function(a,b){return{x:a,y:Math.log(Math.tan((Math.PI/2+b/180*Math.PI)/2))}},w=function(a,b){return{x:a*Math.cos(b/180*Math.PI),y:b}},E=function(a,b){return{x:a*
(2*Math.cos(2*b/180*Math.PI/3)-1),y:180*Math.sin(b/180*Math.PI/3)}};k.prototype=Object.create(JSROOT.ObjectPainter.prototype);k.prototype.getFramePainter=function(){return this};k.prototype.is_root6=function(){return!0};k.prototype.getObject=function(a){return"xaxis"===a?this.xaxis:"yaxis"===a?this.yaxis:JSROOT.ObjectPainter.prototype.getObject.call(this)};k.prototype.setFrameActive=function(a){this.enabledKeys=a&&JSROOT.settings.HandleKeys?!0:!1;this.control&&(this.control.enableKeys=this.enabledKeys)};
k.prototype.shrinkFrame=function(a,b){this.fX1NDC+=a;this.fX2NDC-=b};k.prototype.setLastEventPos=function(a){this.fLastEventPnt=a};k.prototype.getLastEventPos=function(){return this.fLastEventPnt};k.prototype.getProjectionFunc=function(){switch(this.projection){case 1:return J;case 2:return T;case 3:return w;case 4:return E}};k.prototype.recalculateRange=function(a){this.projection=a||0;2==this.projection&&(-90>=this.scale_ymin||90<=this.scale_ymax)&&(console.warn("Mercator Projection","Latitude out of range",
this.scale_ymin,this.scale_ymax),this.projection=0);var b=this.getProjectionFunc();if(b)for(a=[b(this.scale_xmin,this.scale_ymin),b(this.scale_xmin,this.scale_ymax),b(this.scale_xmax,this.scale_ymax),b(this.scale_xmax,this.scale_ymin)],0>this.scale_xmin&&0<this.scale_xmax&&(a.push(b(0,this.scale_ymin)),a.push(b(0,this.scale_ymax))),0>this.scale_ymin&&0<this.scale_ymax&&(a.push(b(this.scale_xmin,0)),a.push(b(this.scale_xmax,0))),this.original_xmin=this.scale_xmin,this.original_xmax=this.scale_xmax,
this.original_ymin=this.scale_ymin,this.original_ymax=this.scale_ymax,this.scale_xmin=this.scale_xmax=a[0].x,this.scale_ymin=this.scale_ymax=a[0].y,b=1;b<a.length;++b)this.scale_xmin=Math.min(this.scale_xmin,a[b].x),this.scale_xmax=Math.max(this.scale_xmax,a[b].x),this.scale_ymin=Math.min(this.scale_ymin,a[b].y),this.scale_ymax=Math.max(this.scale_ymax,a[b].y)};k.prototype.setAxesRanges=function(a,b,c,d,g,l,e,f,h){this.ranges_set=!0;this.xaxis=a;this.xmin=b;this.xmax=c;this.yaxis=d;this.ymin=g;this.ymax=
l;this.zaxis=e;this.zmin=f;this.zmax=h};k.prototype.setAxes2Ranges=function(a,b,c,d,g,l,e,f){a&&(this.x2axis=b,this.x2min=c,this.x2max=d);g&&(this.y2axis=l,this.y2min=e,this.y2max=f)};k.prototype.getAxis=function(a){switch(a){case "x":return this.xaxis;case "y":return this.yaxis;case "z":return this.zaxis;case "x2":return this.x2axis;case "y2":return this.y2axis}return null};k.prototype.applyPadUserRange=function(a,b){if(a){var c=a["fU"+b+"min"],d=a["fU"+b+"max"],g=1E-7;if("x"==b){if(Math.abs(a.fX1)>
g||Math.abs(a.fX2-1)>g)d=a.fX2-a.fX1,c=a.fX1+d*a.fLeftMargin,d=a.fX2-d*a.fRightMargin}else if(Math.abs(a.fY1)>g||Math.abs(a.fY2-1)>g)d=a.fY2-a.fY1,c=a.fY1+d*a.fBottomMargin,d=a.fY2-d*a.fTopMargin;if(!(c>=d||Math.abs(c)<g&&Math.abs(d-1)<g)){0<a["fLog"+b]&&(c=Math.exp(c*Math.log(10)),d=Math.exp(d*Math.log(10)));a=b;this.swap_xy&&(a="x"==b?"y":"x");b="scale_"+a+"min";var l="scale_"+a+"max";g=1E-7*(this[l]-this[b]);if(Math.abs(c-this[b])>g||Math.abs(d-this[l])>g)this["zoom_"+a+"min"]=c,this["zoom_"+a+
"max"]=d}}};k.prototype.createXY=function(a){var b=this;this.cleanXY();a||(a={ndim:1});this.swap_xy=a.swap_xy||!1;this.reverse_x=a.reverse_x||!1;this.reverse_y=a.reverse_y||!1;this.logx=this.logy=0;var c=this.getFrameWidth(),d=this.getFrameHeight(),g=this.getPadPainter().getRootPad();this.scale_xmin=this.xmin;this.scale_xmax=this.xmax;this.scale_ymin=this.ymin;this.scale_ymax=this.ymax;a.extra_y_space&&(this.scale_ymax=(this.swap_xy?g.fLogx:g.fLogy)&&0<this.scale_ymax?Math.exp(1.1*Math.log(this.scale_ymax)):
this.scale_ymax+.1*(this.scale_ymax-this.scale_ymin));if(a.check_pad_range){var l=function(a){if(!b.zoomChangedInteractive(a)){b["zoom_"+a+"min"]=b["zoom_"+a+"max"]=0;var c=b.getAxis(a);c&&c.TestBit(JSROOT.EAxisBits.kAxisRange)&&c.fFirst!==c.fLast&&(1<c.fFirst||c.fLast<c.fNbins)&&(b["zoom_"+a+"min"]=1<c.fFirst?c.GetBinLowEdge(c.fFirst):c.fXmin,b["zoom_"+a+"max"]=c.fLast<c.fNbins?c.GetBinLowEdge(c.fLast+1):c.fXmax,c.InvertBit(JSROOT.EAxisBits.kAxisRange),c.fFirst=1,c.fLast=c.fNbins)}};l("x");1<a.ndim&&
...
this.recalculateRange(a.Proj);this.x_handle=new n(this.getDom(),this.xaxis,!0);this.x_handle.setPadName(this.getPadName());this.x_handle.configureAxis("xaxis",this.xmin,this.xmax,this.scale_xmin,this.scale_xmax,this.swap_xy,this.swap_xy?[0,d]:[0,c],{reverse:this.reverse_x,log:this.swap_xy?g.fLogy:g.fLogx,symlog:this.swap_xy?a.symlog_y:a.symlog_x,logcheckmin:this.swap_xy,logminfactor:1E-4});this.x_handle.assignFrameMembers(this,"x");this.y_handle=new n(this.getDom(),this.yaxis,!0);this.y_handle.setPadName(this.getPadName());
this.y_handle.configureAxis("yaxis",this.ymin,this.ymax,this.scale_ymin,this.scale_ymax,!this.swap_xy,this.swap_xy?[0,c]:[0,d],{reverse:this.reverse_y,log:this.swap_xy?g.fLogx:g.fLogy,symlog:this.swap_xy?a.symlog_x:a.symlog_y,logcheckmin:2>a.ndim||this.swap_xy,log_min_nz:a.ymin_nz&&a.ymin_nz<.01*this.ymax?.3*a.ymin_nz:0,logminfactor:3E-4});this.y_handle.assignFrameMembers(this,"y");this.setRootPadRange(g)};k.prototype.createXY2=function(a){a||(a={});this.reverse_x2=a.reverse_x||!1;this.reverse_y2=
a.reverse_y||!1;this.logx2=this.logy2=0;var b=this.getFrameWidth(),c=this.getFrameHeight(),d=this.getPadPainter().getRootPad();a.second_x&&(this.scale_x2min=this.x2min,this.scale_x2max=this.x2max);a.second_y&&(this.scale_y2min=this.y2min,this.scale_y2max=this.y2max);a.extra_y_space&&a.second_y&&(this.scale_y2max=(this.swap_xy?d.fLogx:d.fLogy)&&0<this.scale_y2max?Math.exp(1.1*Math.log(this.scale_y2max)):this.scale_y2max+.1*(this.scale_y2max-this.scale_y2min));this.zoom_x2min!=this.zoom_x2max&&a.second_x&&
(this.scale_x2min=this.zoom_x2min,this.scale_x2max=this.zoom_x2max);this.zoom_y2min!=this.zoom_y2max&&a.second_y&&(this.scale_y2min=this.zoom_y2min,this.scale_y2max=this.zoom_y2max);a.second_x&&(this.x2_handle=new n(this.getDom(),this.x2axis,!0),this.x2_handle.setPadName(this.getPadName()),this.x2_handle.configureAxis("x2axis",this.x2min,this.x2max,this.scale_x2min,this.scale_x2max,this.swap_xy,this.swap_xy?[0,c]:[0,b],{reverse:this.reverse_x2,log:this.swap_xy?d.fLogy:d.fLogx,logcheckmin:this.swap_xy,
logminfactor:1E-4}),this.x2_handle.assignFrameMembers(this,"x2"));a.second_y&&(this.y2_handle=new n(this.getDom(),this.y2axis,!0),this.y2_handle.setPadName(this.getPadName()),this.y2_handle.configureAxis("y2axis",this.y2min,this.y2max,this.scale_y2min,this.scale_y2max,!this.swap_xy,this.swap_xy?[0,b]:[0,c],{reverse:this.reverse_y2,log:this.swap_xy?d.fLogx:d.fLogy,logcheckmin:2>a.ndim||this.swap_xy,log_min_nz:a.ymin_nz&&a.ymin_nz<.01*this.y2max?.3*a.ymin_nz:0,logminfactor:3E-4}),this.y2_handle.assignFrameMembers(this,
"y2"))};k.prototype.getGrFuncs=function(a,b){a=a&&this.grx2;b=b&&this.gry2;return a||b?{use_x2:a,grx:a?this.grx2:this.grx,logx:this.logx,x_handle:a?this.x2_handle:this.x_handle,scale_xmin:a?this.scale_x2min:this.scale_xmin,scale_xmax:a?this.scale_x2max:this.scale_xmax,use_y2:b,gry:b?this.gry2:this.gry,logy:this.logy,y_handle:b?this.y2_handle:this.y_handle,scale_ymin:b?this.scale_y2min:this.scale_ymin,scale_ymax:b?this.scale_y2max:this.scale_ymax,swap_xy:this.swap_xy,fp:this,revertAxis:function(a,
b){"x"==a&&this.use_x2&&(a="x2");"y"==a&&this.use_y2&&(a="y2");return this.fp.revertAxis(a,b)},axisAsText:function(a,b){"x"==a&&this.use_x2&&(a="x2");"y"==a&&this.use_y2&&(a="y2");return this.fp.axisAsText(a,b)}}:this};k.prototype.setRootPadRange=function(a,b){if(a&&this.ranges_set){b?(a.fUxmin=a.fUymin=-.9,a.fUxmax=a.fUymax=.9):(a.fLogx=this.swap_xy?this.logy:this.logx,a.fUxmin=a.fLogx?Math.log10(this.scale_xmin):this.scale_xmin,a.fUxmax=a.fLogx?Math.log10(this.scale_xmax):this.scale_xmax,a.fLogy=
this.swap_xy?this.logx:this.logy,a.fUymin=a.fLogy?Math.log10(this.scale_ymin):this.scale_ymin,a.fUymax=a.fLogy?Math.log10(this.scale_ymax):this.scale_ymax);b=a.fUxmax-a.fUxmin;var c=1-a.fLeftMargin-a.fRightMargin,d=a.fUymax-a.fUymin,g=1-a.fBottomMargin-a.fTopMargin;0>=c&&(c=.01);0>=g&&(g=.01);a.fX1=a.fUxmin-b/c*a.fLeftMargin;a.fX2=a.fUxmax+b/c*a.fRightMargin;a.fY1=a.fUymin-d/g*a.fBottomMargin;a.fY2=a.fUymax+d/g*a.fTopMargin}};k.prototype.drawGrids=function(){var a=this.getFrameSvg().select(".grid_layer");
a.selectAll(".xgrid").remove();a.selectAll(".ygrid").remove();var b=this.getPadPainter(),c=b?b.getRootPad(!0):null,d=this.getFrameHeight(),g=this.getFrameWidth();b=JSROOT.gStyle.fGridStyle;if(0>b||b>=f.root_line_styles.length)b=11;if(c&&c.fGridx&&this.x_handle){for(var l="",e=0;e<this.x_handle.ticks.length;++e)l=this.swap_xy?l+("M0,"+this.x_handle.ticks[e]+"h"+g):l+("M"+this.x_handle.ticks[e]+",0v"+d);e=0<JSROOT.gStyle.fGridColor?JSROOT.gStyle.fGridColor:this.getAxis("x")?this.getAxis("x").fAxisColor:
1;e=this.getColor(e)||"black";0<l.length&&a.append("svg:path").attr("class","xgrid").attr("d",l).style("stroke",e).style("stroke-width",JSROOT.gStyle.fGridWidth).style("stroke-dasharray",f.root_line_styles[b])}if(c&&c.fGridy&&this.y_handle){c="";for(l=0;l<this.y_handle.ticks.length;++l)c=this.swap_xy?c+("M"+this.y_handle.ticks[l]+",0v"+d):c+("M0,"+this.y_handle.ticks[l]+"h"+g);d=0<JSROOT.gStyle.fGridColor?JSROOT.gStyle.fGridColor:this.getAxis("y")?this.getAxis("y").fAxisColor:1;d=this.getColor(d)||
"black";0<c.length&&a.append("svg:path").attr("class","ygrid").attr("d",c).style("stroke",d).style("stroke-width",JSROOT.gStyle.fGridWidth).style("stroke-dasharray",f.root_line_styles[b])}};k.prototype.axisAsText=function(a,b){var c=this[a+"_handle"];return c?c.axisAsText(b,JSROOT.settings[a.toUpperCase()+"ValuesFormat"]):b.toPrecision(4)};k.prototype.hasDrawnAxes=function(a,b){return a||b?!1:this.axes_drawn};k.prototype.drawAxes=function(a,b,c,d,g){var l=this;this.cleanAxesDrawings();if(this.xmin==
this.xmax||this.ymin==this.ymax)return Promise.resolve(!1);void 0===d&&(d=0);var e=this.getFrameSvg().select(".axis_layer"),f=this.getFrameWidth(),h=this.getFrameHeight(),t=this.getPadPainter().getRootPad(!0);this.x_handle.invert_side=10<=d;this.x_handle.lbls_both_sides=!this.x_handle.invert_side&&t&&1<t.fTickx;this.x_handle.has_obstacle=g;this.y_handle.invert_side=1===d%10;this.y_handle.lbls_both_sides=!this.y_handle.invert_side&&t&&1<t.fTicky;d=this.swap_xy?this.y_handle:this.x_handle;var k=this.swap_xy?
this.x_handle:this.y_handle;b&&c||(g=this.getPadPainter())&&g._fast_drawing&&(b=c=!0);if(b&&c)c=Promise.resolve(!0);else{var u=!a&&JSROOT.settings.CanAdjustFrame;b=d.drawAxis(e,f,h,d.invert_side?void 0:"translate(0,"+h+")",t&&t.fTickx?-h:0,b,void 0,!1);c=k.drawAxis(e,f,h,k.invert_side?"translate("+f+",0)":void 0,t&&t.fTicky?f:0,c,k.invert_side?0:this._frame_x,u);c=Promise.all([b,c]).then(function(){l.drawGrids();if(u){var a=0,b=k.position;-.2*f<b&&0>b?(a=-b/f+.001,l.shrink_frame_left+=a):0<b&&b<.3*
f&&0<l.shrink_frame_left&&b/f>l.shrink_frame_left&&(a=-l.shrink_frame_left,l.shrink_frame_left=0);if(0!=a)return l.shrinkFrame(a,0),l.redraw(),l.drawAxes(!0)}})}return c.then(function(){a||(l.axes_drawn=!0);return!0})};k.prototype.drawAxes2=function(a,b){var c=this.getFrameSvg().select(".axis_layer"),d=this.getFrameWidth(),g=this.getFrameHeight(),l=this.getPadPainter().getRootPad(!0);a&&(this.x2_handle.invert_side=!0,this.x2_handle.lbls_both_sides=!1,this.x2_handle.has_obstacle=!1);b&&(this.y2_handle.invert_side=
!0,this.y2_handle.lbls_both_sides=!1);a=this.swap_xy?this.y2_handle:this.x2_handle;b=this.swap_xy?this.x2_handle:this.y2_handle;if(a||b){var e=this.getPadPainter();e&&e._fast_drawing&&(a=b=null)}var f=e=!0;a&&(e=a.drawAxis(c,d,g,a.invert_side?void 0:"translate(0,"+g+")",l&&l.fTickx?-g:0,!1,void 0,!1));b&&(f=b.drawAxis(c,d,g,b.invert_side?"translate("+d+",0)":void 0,l&&l.fTicky?d:0,!1,b.invert_side?0:this._frame_x,!1));return Promise.all([e,f])};k.prototype.updateAttributes=function(a){var b=this.getPadPainter(),
c=b?b.getRootPad(!0):null,d=this.getObject();if(void 0===this.fX1NDC||a&&!this.modified_NDC)c?JSROOT.extend(this,{fX1NDC:c.fLeftMargin,fX2NDC:1-c.fRightMargin,fY1NDC:c.fBottomMargin,fY2NDC:1-c.fTopMargin}):JSROOT.extend(this,JSROOT.settings.FrameNDC);void 0===this.fillatt&&(d?this.createAttFill({attr:d}):c&&c.fFrameFillColor?this.createAttFill({pattern:c.fFrameFillStyle,color:c.fFrameFillColor}):c?this.createAttFill({attr:c}):this.createAttFill({pattern:1001,color:0}),!d&&this.fillatt.empty()&&b&&
b.iscan&&this.fillatt.setSolidColor("white"));!d&&c&&void 0!==c.fFrameLineColor?this.createAttLine({color:c.fFrameLineColor,width:c.fFrameLineWidth,style:c.fFrameLineStyle}):this.createAttLine({attr:d,color:"black"})};k.prototype.sizeChanged=function(){var a=this.getPadPainter();if(a=a?a.getRootPad(!0):null)a.fLeftMargin=this.fX1NDC,a.fRightMargin=1-this.fX2NDC,a.fBottomMargin=this.fY1NDC,a.fTopMargin=1-this.fY2NDC,this.setRootPadRange(a);this.interactiveRedraw("pad","frame")};k.prototype.cleanXY=
function(){delete this.grx;delete this.gry;delete this.grz;this.x_handle&&(this.x_handle.cleanup(),delete this.x_handle);this.y_handle&&(this.y_handle.cleanup(),delete this.y_handle);this.z_handle&&(this.z_handle.cleanup(),delete this.z_handle);delete this.grx2;delete this.gry2;this.x2_handle&&(this.x2_handle.cleanup(),delete this.x2_handle);this.y2_handle&&(this.y2_handle.cleanup(),delete this.y2_handle)};k.prototype.cleanAxesDrawings=function(){this.x_handle&&this.x_handle.removeG();this.y_handle&&
this.y_handle.removeG();this.z_handle&&this.z_handle.removeG();this.x2_handle&&this.x2_handle.removeG();this.y2_handle&&this.y2_handle.removeG();var a=this.getG();a&&(a.select(".grid_layer").selectAll("*").remove(),a.select(".axis_layer").selectAll("*").remove());this.axes_drawn=!1};k.prototype.cleanFrameDrawings=function(){"function"===typeof this.create3DScene&&this.create3DScene(-1);this.cleanAxesDrawings();this.cleanXY();this.ranges_set=!1;this.scale_zmin=this.scale_zmax=this.scale_ymin=this.scale_ymax=
this.scale_xmin=this.scale_xmax=this.zoom_zmin=this.zoom_zmax=this.zoom_ymin=this.zoom_ymax=this.zoom_xmin=this.zoom_xmax=this.zmin=this.zmax=this.ymin=this.ymax=this.xmin=this.xmax=0;this.draw_g&&(this.draw_g.select(".main_layer").selectAll("*").remove(),this.draw_g.select(".upper_layer").selectAll("*").remove());this.zaxis=this.yaxis=this.xaxis=null;this.draw_g&&(this.draw_g.selectAll("*").remove(),this.draw_g.on("mousedown",null).on("dblclick",null).on("wheel",null).on("contextmenu",null).property("interactive_set",
null),this.draw_g.remove());delete this.draw_g;this.keys_handler&&(window.removeEventListener("keydown",this.keys_handler,!1),this.keys_handler=null)};k.prototype.cleanup=function(){this.cleanFrameDrawings();delete this._click_handler;delete this._dblclick_handler;delete this.enabledKeys;var a=this.getPadPainter();a&&a.frame_painter_ref===this&&delete a.frame_painter_ref;JSROOT.ObjectPainter.prototype.cleanup.call(this)};k.prototype.redraw=function(){var a=this,b=this.getPadPainter();b&&(b.frame_painter_ref=
this);this.updateAttributes();var c=b?b.getPadRect():{width:10,height:10},d=Math.round(c.width*this.fX1NDC),g=Math.round(c.width*(this.fX2NDC-this.fX1NDC)),l=Math.round(c.height*(1-this.fY2NDC));c=Math.round(c.height*(this.fY2NDC-this.fY1NDC));var e=!1,f=!1;b&&b.options&&(b.options.RotateFrame&&(e=!0),b.options.FixFrame&&(f=!0));if(e){b="rotate(-90,"+d+","+l+") translate("+(d-c)+","+l+")";var h=g;g=c;c=h}else b="translate("+d+","+l+")";this._frame_x=d;this._frame_y=l;this._frame_width=g;this._frame_height=
c;this._frame_rotate=e;this._frame_fixpos=f;this.mode3d||(this.draw_g=this.getLayerSvg("primitives_layer").select(".root_frame"),this.draw_g.empty()?(this.draw_g=this.getLayerSvg("primitives_layer").append("svg:g").attr("class","root_frame"),this.draw_g.append("svg:title").text(""),d=this.draw_g.append("svg:path"),this.draw_g.append("svg:g").attr("class","grid_layer"),l=this.draw_g.append("svg:svg").attr("class","main_layer").attr("x",0).attr("y",0).attr("overflow","hidden"),this.draw_g.append("svg:g").attr("class",
"axis_layer"),this.draw_g.append("svg:g").attr("class","upper_layer")):(d=this.draw_g.select("path"),l=this.draw_g.select(".main_layer")),this.axes_drawn=!1,this.draw_g.attr("transform",b),d.attr("d","M0,0H"+g+"V"+c+"H0Z").call(this.fillatt.func).call(this.lineatt.func),l.attr("width",g).attr("height",c).attr("viewBox","0 0 "+g+" "+c),JSROOT.batch_mode||(d.attr("pointer-events","visibleFill"),JSROOT.require(["interactive"]).then(function(b){b.FrameInteractive.assign(a);a.addBasicInteractivity()})))};
k.prototype.changeAxisLog=function(a,b){var c=this.getPadPainter(),d=c?c.getRootPad(!0):null;if(d){c._interactively_changed=!0;c="fLog"+a;if(!d[c]){this.swap_xy&&"x"===a?a="y":this.swap_xy&&"y"===a&&(a="x");var g=this[a+"_handle"];if(g&&"labels"===g.kind)return}if("toggle"==b||void 0===b)b=d[c]?0:1;d[c]=b;this.interactiveRedraw("pad","log"+a)}};k.prototype.toggleAxisLog=function(a){this.changeAxisLog(a,"toggle")};k.prototype.fillContextMenu=function(a,b,c){var d=this,g=this.getMainPainter(),l=this.getPadPainter(),
e=l?l.getRootPad(!0):null;if("x"==b||"y"==b||"z"==b||"x2"==b||"y2"==b){var f=c||this[b+"axis"];a.add("header: "+b.toUpperCase()+" axis");a.add("Unzoom",function(){return d.unzoom(b)});e&&(a.add("sub:SetLog "+b[0]),a.addchk(0==e["fLog"+b[0]],"linear",function(){return d.changeAxisLog(b[0],0)}),a.addchk(1==e["fLog"+b[0]],"log",function(){return d.changeAxisLog(b[0],1)}),a.addchk(2==e["fLog"+b[0]],"log2",function(){return d.changeAxisLog(b[0],2)}),a.add("endsub:"));a.addchk(f.TestBit(JSROOT.EAxisBits.kMoreLogLabels),
"More log",function(){f.InvertBit(JSROOT.EAxisBits.kMoreLogLabels);d.redrawPad()});a.addchk(f.TestBit(JSROOT.EAxisBits.kNoExponent),"No exponent",function(){f.InvertBit(JSROOT.EAxisBits.kNoExponent);d.redrawPad()});"z"===b&&g&&g.options&&g.options.Zscale&&"function"==typeof g.fillPaletteMenu&&g.fillPaletteMenu(a);if(f){var h=this[b+"_handle"];h&&"labels"==h.kind&&20<f.fNbins&&a.add("Find label",function(){return a.input("Label id").then(function(a){if(a)for(var c=0;c<f.fNbins;++c)if(h.formatLabels(c)==
a)return d.zoom(b,Math.max(0,c-4),Math.min(f.fNbins,c+5))})});a.addTAxisMenu(g||this,f,b)}return!0}(c=0==a.size())?a.add("header:Frame"):a.add("separator");this.zoom_xmin!==this.zoom_xmax&&a.add("Unzoom X",function(){return d.unzoom("x")});this.zoom_ymin!==this.zoom_ymax&&a.add("Unzoom Y",function(){return d.unzoom("y")});this.zoom_zmin!==this.zoom_zmax&&a.add("Unzoom Z",function(){return d.unzoom("z")});this.zoom_x2min!==this.zoom_x2max&&a.add("Unzoom X2",function(){return d.unzoom("x2")});this.zoom_y2min!==
this.zoom_y2max&&a.add("Unzoom Y2",function(){return d.unzoom("y2")});a.add("Unzoom all",function(){return d.unzoom("all")});e&&(a.addchk(e.fLogx,"SetLogx",function(){return d.toggleAxisLog("x")}),a.addchk(e.fLogy,"SetLogy",function(){return d.toggleAxisLog("y")}),g&&"function"===typeof g.getDimension&&1<g.getDimension()&&a.addchk(e.fLogz,"SetLogz",function(){return d.toggleAxisLog("z")}),a.add("separator"));a.addchk(this.isTooltipAllowed(),"Show tooltips",function(){return d.setTooltipAllowed("toggle")});
a.addAttributesMenu(this,c?"":"Frame ");a.add("separator");a.add("Save as frame.png",function(){return l.saveAs("png","frame","frame.png")});a.add("Save as frame.svg",function(){return l.saveAs("svg","frame","frame.svg")});return!0};k.prototype.fillWebObjectOptions=function(a){if(!a){if(!this.snapid)return null;a={_typename:"TWebObjectOptions",snapid:this.snapid.toString(),opt:this.getDrawOpt(),fcust:"",fopt:[]}}a.fcust="frame";a.fopt=[this.scale_xmin||0,this.scale_ymin||0,this.scale_xmax||0,this.scale_ymax||
0];return a};k.prototype.getFrameWidth=function(){return this._frame_width||0};k.prototype.getFrameHeight=function(){return this._frame_height||0};k.prototype.getFrameRect=function(){return{x:this._frame_x||0,y:this._frame_y||0,width:this.getFrameWidth(),height:this.getFrameHeight(),transform:this.draw_g?this.draw_g.attr("transform"):"",hint_delta_x:0,hint_delta_y:0}};k.prototype.configureUserClickHandler=function(a){this._click_handler=a&&"function"==typeof a?a:null};k.prototype.configureUserDblclickHandler=
function(a){this._dblclick_handler=a&&"function"==typeof a?a:null};k.prototype.zoom=function(a,b,c,d,g,l){var e=this;if(this.projection)return Promise.resolve(!1);"x"===a?(a=b,b=c,c=void 0):"y"===a?(d=c,c=b,a=b=void 0):"z"===a&&(g=b,l=c,a=b=c=void 0);var f=a!==b,h=c!==d,k=g!==l,m=!1,u=!1,q=!1;if(f){var r=0;a<=this.xmin&&(a=this.xmin,r++);b>=this.xmax&&(b=this.xmax,r++);2===r&&(f=!1,m=!0)}else m=a===b&&0===a;h?(r=0,c<=this.ymin&&(c=this.ymin,r++),d>=this.ymax&&(d=this.ymax,r++),2===r&&(h=!1,u=!0)):
u=c===d&&0===c;k?(r=0,g<=this.zmin&&(g=this.zmin,r++),l>=this.zmax&&(l=this.zmax,r++),2===r&&(k=!1,q=!0)):q=g===l&&0===g;var n=!1;(f||h||k)&&this.forEachPainter(function(p){"function"==typeof p.canZoomInside&&(f&&p.canZoomInside("x",a,b)&&(e.zoom_xmin=a,e.zoom_xmax=b,n=!0,f=!1),h&&p.canZoomInside("y",c,d)&&(e.zoom_ymin=c,e.zoom_ymax=d,n=!0,h=!1),k&&p.canZoomInside("z",g,l)&&(e.zoom_zmin=g,e.zoom_zmax=l,n=!0,k=!1))});if(m||u||q)m&&(this.zoom_xmin!==this.zoom_xmax&&(n=!0),this.zoom_xmin=this.zoom_xmax=
0),u&&(this.zoom_ymin!==this.zoom_ymax&&(n=!0),this.zoom_ymin=this.zoom_ymax=0),q&&(this.zoom_zmin!==this.zoom_zmax&&(n=!0),this.zoom_zmin=this.zoom_zmax=0),n||(r=this.getPadPainter())&&r.painters&&r.painters.forEach(function(a){a&&"function"==typeof a.unzoomUserRange&&a.unzoomUserRange(m,u,q)&&(n=!0)});return n?this.interactiveRedraw("pad","zoom").then(function(){return!0}):Promise.resolve(!1)};k.prototype.zoomSingle=function(a,b,c){var d=this;if(this.projection||!this[a+"_handle"])return Promise.resolve(!1);
var g=b!==c,e=!1;if(g){var f=0;b<=this[a+"min"]&&(b=this[a+"min"],f++);c>=this[a+"max"]&&(c=this[a+"max"],f++);2===f&&(g=!1,e=!0)}else e=b===c&&0===b;var h=!1;g&&this.forEachPainter(function(e){"function"==typeof e.canZoomInside&&g&&e.canZoomInside(a[0],b,c)&&(d["zoom_"+a+"min"]=b,d["zoom_"+a+"max"]=c,h=!0,g=!1)});e&&(this["zoom_"+a+"min"]!==this["zoom_"+a+"max"]&&(h=!0),this["zoom_"+a+"min"]=this["zoom_"+a+"max"]=0);return h?this.interactiveRedraw("pad","zoom").then(function(){return!0}):Promise.resolve(!1)};
k.prototype.isAxisZoomed=function(a){return this["zoom_"+a+"min"]!==this["zoom_"+a+"max"]};k.prototype.unzoom=function(a,b,c){var d=this;if("all"==a)return this.unzoom("x2").then(function(){return d.unzoom("y2")}).then(function(){return d.unzoom("xyz")});if("x2"==a||"y2"==a)return this.zoomSingle(a,0,0).then(function(b){b&&d.zoomChangedInteractive(a,"unzoom");return b});"undefined"===typeof a?a=b=c=!0:"string"===typeof a&&(c=0<=a.indexOf("z"),b=0<=a.indexOf("y"),a=0<=a.indexOf("x"));return this.zoom(a?
0:void 0,a?0:void 0,b?0:void 0,b?0:void 0,c?0:void 0,c?0:void 0).then(function(g){g&&a&&d.zoomChangedInteractive("x","unzoom");g&&b&&d.zoomChangedInteractive("y","unzoom");g&&c&&d.zoomChangedInteractive("z","unzoom");return g})};k.prototype.zoomChangedInteractive=function(a,b){if("reset"==a)this.zoom_changed_x=this.zoom_changed_y=this.zoom_changed_z=void 0;else{if(!a||"any"==a)return this.zoom_changed_x||this.zoom_changed_y||this.zoom_changed_z;if("x"===a||"y"===a||"z"===a){a="zoom_changed_"+a;if(void 0===
b)return this[a];"unzoom"===b?this[a]?delete this[a]:this[a]=!0:b&&(this[a]=!0)}}};k.prototype.revertAxis=function(a,b){return(a=this[a+"_handle"])?a.revertPoint(b):0};k.prototype.showAxisStatus=function(a,b){var c=this.getAxis(a),d=a,g="TAxis";b=h.pointer(b,this.getFrameSvg().node());var e="x"==a?0:1;c&&(d=c.fName,g=c.fTitle||"TAxis object for "+a);this.swap_xy&&(e=1-e);c=this.revertAxis(a,b[e]);this.showObjectStatus(d,g,a+" : "+this.axisAsText(a,c),b[0]+","+b[1])};k.prototype.addKeysHandler=function(){var a=
this;JSROOT.batch_mode||JSROOT.require(["interactive"]).then(function(b){b.FrameInteractive.assign(a);a.addKeysHandler()})};k.prototype.addInteractivity=function(a){var b=this;return JSROOT.batch_mode||!JSROOT.settings.Zooming&&!JSROOT.settings.ContextMenu?Promise.resolve(!1):JSROOT.require(["interactive"]).then(function(c){c.FrameInteractive.assign(b);return b.addInteractivity(a)})};var P=function(a,b,c){var d=new k(a,b);return f.ensureTCanvas(d,!1).then(function(){"3d"==c&&(d.mode3d=!0);d.redraw();
return d})};e.prototype=Object.create(JSROOT.ObjectPainter.prototype);e.prototype.isRoot6=function(){return!0};e.prototype.svg_this_pad=function(){return this.getPadSvg(this.this_pad_name)};e.prototype.getMainPainter=function(){return this.main_painter_ref||null};e.prototype.setMainPainter=function(a,b){if(!this.main_painter_ref||b)this.main_painter_ref=a};e.prototype.cleanup=function(){this._doing_draw&&console.error("pad drawing is not completed when cleanup is called");this.painters.forEach(function(a){return a.cleanup()});
var a=this.svg_this_pad();a.empty()||(a.property("pad_painter",null),this.iscan||a.remove());delete this.main_painter_ref;delete this.frame_painter_ref;delete this.pads_cache;delete this.custom_palette;delete this._pad_x;delete this._pad_y;delete this._pad_width;delete this._pad_height;delete this._doing_draw;delete this._interactively_changed;this.painters=[];this.pad=null;this.this_pad_name=void 0;this.has_canvas=!1;f.selectActivePad({pp:this,active:!1});JSROOT.ObjectPainter.prototype.cleanup.call(this)};
e.prototype.getFramePainter=function(){return this.frame_painter_ref};e.prototype.getPadWidth=function(){return this._pad_width||0};e.prototype.getPadHeight=function(){return this._pad_height||0};e.prototype.getPadRect=function(){return{x:this._pad_x||0,y:this._pad_y||0,width:this.getPadWidth(),height:this.getPadHeight()}};e.prototype.getRootPad=function(a){return void 0===a||a?this.pad:null};e.prototype.cleanPrimitives=function(a){if(a&&"function"===typeof a)for(var b=this.painters.length-1;0<=b;--b)a(this.painters[b])&&
(this.painters[b].cleanup(),this.painters.splice(b,1))};e.prototype.getCustomPalette=function(){if(this.custom_palette)return this.custom_palette;var a=this.getCanvPainter();return a?a.custom_palette:null};e.prototype.forEachPainterInPad=function(a,b){b||(b="all");"objects"!=b&&a(this);for(var c=0;c<this.painters.length;++c){var d=this.painters[c];"function"===typeof d.forEachPainterInPad?"objects"!=b&&d.forEachPainterInPad(a,b):"pads"!=b&&a(d)}};e.prototype.forEachPainter=e.prototype.forEachPainterInPad;
e.prototype.registerForPadEvents=function(a){this.pad_events_receiver=a};e.prototype.producePadEvent=function(a,b,c,d,g){"select"==a&&"function"==typeof this.selectActivePad&&this.selectActivePad(b,c,d);this.pad_events_receiver&&this.pad_events_receiver({what:a,padpainter:b,painter:c,position:d,place:g})};e.prototype.selectObjectPainter=function(a,b,c){var d=this.iscan||!this.has_canvas,g=d?this:this.getCanvPainter();void 0===a&&(a=this);b&&!d&&(b=f.getAbsPosInCanvas(this.svg_this_pad(),b));f.selectActivePad({pp:this,
active:!0});g&&g.producePadEvent("select",this,a,b,c)};e.prototype.drawActiveBorder=function(a,b){if(void 0!==b){if(this.is_active_pad===b)return;this.is_active_pad=b}void 0!==this.is_active_pad&&(a||(a=this.iscan?this.getCanvSvg().select(".canvas_fillrect"):this.svg_this_pad().select(".root_pad_border")),(b=this.is_active_pad?new JSROOT.TAttLineHandler({style:1,width:1,color:"red"}):this.lineatt)||(b=new JSROOT.TAttLineHandler({color:"none"})),a.call(b.func))};e.prototype.createCanvasSvg=function(a,
b){var c=this,d=null,g=null,e=null,h;if(0<a){if(this._fixed_size)return 1<a;g=this.getCanvSvg();if(g.empty())return!1;d=g.property("height_factor");e=this.testMainResize(a,null,d);if(!e.changed)return!1;JSROOT.batch_mode||(h=this.getLayerSvg("btns_layer",this.this_pad_name))}else{a=this.selectDom();"static"==a.style("position")&&a.style("position","relative");g=a.append("svg").attr("class","jsroot root_canvas").property("pad_painter",this).property("current_pad","").property("redraw_by_resize",!1);
this.setTopPainter();JSROOT.batch_mode&&(g.attr("xmlns","http://www.w3.org/2000/svg"),g.attr("xmlns:xlink","http://www.w3.org/1999/xlink"));g.append("svg:title").text("ROOT canvas");e=g.append("svg:path").attr("class","canvas_fillrect");if(!JSROOT.batch_mode)e.style("pointer-events","visibleFill").on("dblclick",function(a){return c.enlargePad(a)}).on("click",function(){return c.selectObjectPainter()}).on("mouseenter",function(){return c.showObjectStatus()});g.append("svg:g").attr("class","primitives_layer");
g.append("svg:g").attr("class","info_layer");JSROOT.batch_mode||(h=g.append("svg:g").attr("class","btns_layer").property("leftside","left"==JSROOT.settings.ToolBarSide).property("vertical",JSROOT.settings.ToolBarVert));if(JSROOT.settings.ContextMenu&&!JSROOT.batch_mode)g.select(".canvas_fillrect").on("contextmenu",function(a){return c.padContextMenu(a)});d=.66;this.pad&&this.pad.fCw&&this.pad.fCh&&0<this.pad.fCw&&(d=this.pad.fCh/this.pad.fCw,.1>d||10<d)&&(d=.66);this._fixed_size?(a.style("overflow",
"auto"),e={width:this.pad.fCw,height:this.pad.fCh},e.width&&e.height||(e=f.getElementRect(a))):e=this.testMainResize(2,b,d)}this.createAttFill({attr:this.pad});5>=e.width||5>=e.height?(g.style("display","none"),console.warn("Hide canvas while geometry too small w="+e.width+" h="+e.height),e.width=200,e.height=100):g.style("display",null);this._fixed_size?g.attr("x",0).attr("y",0).attr("width",e.width).attr("height",e.height).style("position","absolute"):g.attr("x",0).attr("y",0).style("width","100%").style("height",
"100%").style("position","absolute").style("left",0).style("top",0).style("right",0).style("bottom",0);g.attr("viewBox","0 0 "+e.width+" "+e.height).attr("preserveAspectRatio","none").property("height_factor",d).property("draw_x",0).property("draw_y",0).property("draw_width",e.width).property("draw_height",e.height);this._pad_y=this._pad_x=0;this._pad_width=e.width;this._pad_height=e.height;b=g.select(".canvas_fillrect").attr("d","M0,0H"+e.width+"V"+e.height+"H0Z").call(this.fillatt.func);this._fast_drawing=
JSROOT.settings.SmallPad&&(e.width<JSROOT.settings.SmallPad.width||e.height<JSROOT.settings.SmallPad.height);this.drawActiveBorder(b);this.alignButtons&&h&&this.alignButtons(h,e.width,e.height);return!0};e.prototype.enlargePad=function(a){a&&(a.preventDefault(),a.stopPropagation());a=this.getCanvSvg();var b=a.property("pad_enlarged");if(!this.iscan&&this.has_canvas&&(b||this.hasObjectsToDraw()||this.painters))b?b===this.pad?(this.enlargeMain(!1),a.property("pad_enlarged",null)):console.error("missmatch with pad double click events"):
(this.enlargeMain(!0,!0),a.property("pad_enlarged",this.pad));else{if(this._fixed_size||!this.enlargeMain("toggle"))return;"off"==this.enlargeMain("state")&&a.property("pad_enlarged",null)}a=this._fast_drawing;this.checkResize(!0);this._fast_drawing!=a&&this.showPadButtons()};e.prototype.createPadSvg=function(a){var b=this;if(!this.has_canvas)return this.createCanvasSvg(a?2:0),!0;var c=this.getCanvSvg(),d=c.property("draw_width"),g=c.property("draw_height"),e=c.property("pad_enlarged"),f=!this.pad_draw_disabled&&
(!e||e===this.pad),h=Math.round(this.pad.fAbsWNDC*d),k=Math.round(this.pad.fAbsHNDC*g),t=Math.round(this.pad.fAbsXlowNDC*d),m=Math.round(g*(1-this.pad.fAbsYlowNDC))-k,u=null,q=null,r=null;e===this.pad&&(h=d,k=g,t=m=0);if(a)u=this.svg_this_pad(),q=u.select(".root_pad_border"),JSROOT.batch_mode||(r=this.getLayerSvg("btns_layer",this.this_pad_name));else{u=c.select(".primitives_layer").append("svg:svg").classed("__root_pad_"+this.this_pad_name,!0).attr("pad",this.this_pad_name).property("pad_painter",
this);q=u.append("svg:path").attr("class","root_pad_border");u.append("svg:g").attr("class","primitives_layer");JSROOT.batch_mode||(r=u.append("svg:g").attr("class","btns_layer").property("leftside","left"!=JSROOT.settings.ToolBarSide).property("vertical",JSROOT.settings.ToolBarVert));if(JSROOT.settings.ContextMenu)q.on("contextmenu",function(a){return b.padContextMenu(a)});if(!JSROOT.batch_mode)q.attr("pointer-events","visibleFill").on("dblclick",function(a){return b.enlargePad(a)}).on("click",function(){return b.selectObjectPainter()}).on("mouseenter",
function(){return b.showObjectStatus()})}this.createAttFill({attr:this.pad});this.createAttLine({attr:this.pad,color0:0==this.pad.fBorderMode?"none":""});u.attr("display",f?null:"none").attr("viewBox","0 0 "+h+" "+k).attr("preserveAspectRatio","none").attr("x",t).attr("y",m).attr("width",h).attr("height",k).property("draw_x",t).property("draw_y",m).property("draw_width",h).property("draw_height",k);this._pad_x=t;this._pad_y=m;this._pad_width=h;this._pad_height=k;q.attr("d","M0,0H"+h+"V"+k+"H0Z").call(this.fillatt.func).call(this.lineatt.func);
this.drawActiveBorder(q);this._fast_drawing=JSROOT.settings.SmallPad&&(h<JSROOT.settings.SmallPad.width||k<JSROOT.settings.SmallPad.height);u.property("can3d")===JSROOT.constants.Embed3D.Overlay&&this.selectDom().select(".draw3d_"+this.this_pad_name).style("display",f?"":"none");this.alignButtons&&r&&this.alignButtons(r,h,k);return f};e.prototype.disablePadDrawing=function(){this.pad_draw_disabled||!this.has_canvas||this.iscan||(this.pad_draw_disabled=!0,this.createPadSvg(!0))};e.prototype.checkSpecial=
function(a){if(!a)return!1;if("TStyle"==a._typename)return JSROOT.extend(JSROOT.gStyle,a),!0;if("TObjArray"==a._typename&&"ListOfColors"==a.name){if(this.options&&this.options.CreatePalette){for(var b=[],c=a.arr.length-this.options.CreatePalette;c<a.arr.length;++c){var d=f.getRGBfromTColor(a.arr[c]);if(!d){console.log("Fail to create color for palette");b=null;break}b.push(d)}b&&(this.custom_palette=new JSROOT.ColorPalette(b))}this.options&&!this.options.GlobalColors||f.adoptRootColors(a);this.options&&
this.options.LocalColors&&(this.root_colors=f.extendRootColors(null,a));return!0}if("TObjArray"==a._typename&&"CurrentColorPalette"==a.name){b=[];c=!1;for(d=0;d<a.arr.length;++d){var g=a.arr[d];g&&"TColor"==g._typename?b[d]=f.getRGBfromTColor(g):(console.log("Missing color with index "+d),c=!0)}this.options&&(c||this.options.IgnorePalette)||(this.custom_palette=new JSROOT.ColorPalette(b));return!0}return!1};e.prototype.checkSpecialsInPrimitives=function(a){if(a=a?a.fPrimitives:null)for(var b=0;b<
a.arr.length;++b)this.checkSpecial(a.arr[b])&&(a.arr.splice(b,1),a.opt.splice(b,1),b--)};e.prototype.findInPrimitives=function(a,b){var c=this.pad&&this.pad.fPrimitives?this.pad.fPrimitives.arr:null;return c?c.find(function(c){return c.fName==a&&(b?c.typename==b:!0)}):null};e.prototype.findPainterFor=function(a,b,c){return this.painters.find(function(d){if(d=d.getObject()){if(a&&d===a)return!0;if(b||c)if(!b||d.fName===b)if(!c||d._typename===c)return!0}})};e.prototype.hasObjectsToDraw=function(){var a=
this.pad&&this.pad.fPrimitives?this.pad.fPrimitives.arr:null;return a&&a.find(function(a){return"TPad"!=a._typename})?!0:!1};e.prototype.syncDraw=function(a){var b={kind:a||"redraw"};if(void 0===this._doing_draw)return this._doing_draw=[b],Promise.resolve(!0);if(!0!==b.kind&&0<this._doing_draw.findIndex(function(a,d){return 0<d&&a.kind==b.kind}))return!1;this._doing_draw.push(b);return new Promise(function(a){b.func=a})};e.prototype.confirmDraw=function(){if(void 0===this._doing_draw)return console.warn("failure, should not happen");
this._doing_draw.shift();if(0==this._doing_draw.length)delete this._doing_draw;else{var a=this._doing_draw[0];a.func&&(a.func(),delete a.func)}};e.prototype.drawPrimitives=function(a){var b=this;if(void 0===a)return this.iscan&&(this._start_tm=(new Date).getTime()),this._num_primitives=this.pad&&this.pad.fPrimitives?this.pad.fPrimitives.arr.length:0,this.syncDraw(!0).then(function(){return b.drawPrimitives(0)});if(a>=this._num_primitives){if(this._start_tm){var c=(new Date).getTime()-this._start_tm;
1E3<c&&console.log("Canvas "+(this.pad?this.pad.fName:"---")+" drawing took "+(.001*c).toFixed(2)+"s");delete this._start_tm}this.confirmDraw();return Promise.resolve()}return JSROOT.draw(this.getDom(),this.pad.fPrimitives.arr[a],this.pad.fPrimitives.opt[a]).then(function(c){c&&"object"==typeof c&&(c._primitive=!0);return b.drawPrimitives(a+1)})};e.prototype.divide=function(a,b){var c=this;if(!b){var d=a;if(2>d)return Promise.resolve(this);a=b=Math.round(Math.sqrt(d));a*b<d&&(a+=1)}if(2>a*b)return Promise.resolve(this);
d=1/b;for(var g=1/a,e=0,f=[],h=0;h<b;h++){var k=1-h*d-.01,t=k-d+.02;0>t&&(t=0);if(!(t>k))for(var m=0;m<a;m++){var u=m*g+.01,q=u+g-.02;if(!(u>q)){e++;var r=JSROOT.create("TPad");r.fName=r.fTitle=this.pad.fName+"_"+e;r.fNumber=e;this.iscan?(r.fAbsWNDC=q-u,r.fAbsHNDC=k-t,r.fAbsXlowNDC=u,r.fAbsYlowNDC=t):(r.fAbsWNDC=(q-u)*this.pad.fAbsWNDC,r.fAbsHNDC=(k-t)*this.pad.fAbsHNDC,r.fAbsXlowNDC=this.pad.fAbsXlowNDC+u*this.pad.fAbsWNDC,r.fAbsYlowNDC=this.pad.fAbsYlowNDC+t*this.pad.fAbsWNDC);f.push(r)}}}var n=
function(){return 0==f.length?Promise.resolve(c):JSROOT.draw(c.getDom(),f.shift()).then(n)};return n()};e.prototype.getSubPadPainter=function(a){for(var b=0;b<this.painters.length;++b){var c=this.painters[b];if(c.pad&&"function"===typeof c.forEachPainterInPad&&c.pad.fNumber===a)return c}return null};e.prototype.processPadTooltipEvent=function(a){var b=[],c=[];null!==this.painters&&this.painters.forEach(function(a){"function"==typeof a.processTooltipEvent&&b.push(a)});a&&(a.nproc=b.length);b.forEach(function(b){var d=
b.processTooltipEvent(a);d||(d={user_info:null});c.push(d);a&&a.painters&&(d.painter=b)});return c};e.prototype.fillContextMenu=function(a){var b=this;this.pad?a.add("header: "+this.pad._typename+"::"+this.pad.fName):a.add("header: Canvas");a.addchk(this.isTooltipAllowed(),"Show tooltips",function(){return b.setTooltipAllowed("toggle")});if(!this._websocket){var c=function(a){this.pad[a.substr(1)]=parseInt(a[0]);this.interactiveRedraw("pad",a.substr(1))};a.addchk(this.pad.fGridx,"Grid x",(this.pad.fGridx?
"0":"1")+"fGridx",c);a.addchk(this.pad.fGridy,"Grid y",(this.pad.fGridy?"0":"1")+"fGridy",c);a.add("sub:Ticks x");a.addchk(0==this.pad.fTickx,"normal","0fTickx",c);a.addchk(1==this.pad.fTickx,"ticks on both sides","1fTickx",c);a.addchk(2==this.pad.fTickx,"labels on both sides","2fTickx",c);a.add("endsub:");a.add("sub:Ticks y");a.addchk(0==this.pad.fTicky,"normal","0fTicky",c);a.addchk(1==this.pad.fTicky,"ticks on both sides","1fTicky",c);a.addchk(2==this.pad.fTicky,"labels on both sides","2fTicky",
c);a.add("endsub:");a.addAttributesMenu(this)}a.add("separator");"function"==typeof this.hasMenuBar&&"function"==typeof this.actiavteMenuBar&&a.addchk(this.hasMenuBar(),"Menu bar",function(a){return b.actiavteMenuBar(a)});"function"==typeof this.hasEventStatus&&"function"==typeof this.activateStatusBar&&a.addchk(this.hasEventStatus(),"Event status",function(){return b.activateStatusBar("toggle")});(this.enlargeMain()||this.has_canvas&&this.hasObjectsToDraw())&&a.addchk("on"==this.enlargeMain("state"),
"Enlarge "+(this.iscan?"canvas":"pad"),function(){return b.enlargePad()});c=this.this_pad_name;0===c.length&&(c=this.iscan?"canvas":"pad");a.add("Save as "+c+".png",c+".png",function(){return b.saveAs("png",!1)});a.add("Save as "+c+".svg",c+".svg",function(){return b.saveAs("svg",!1)});return!0};e.prototype.padContextMenu=function(a){var b=this;if(a.stopPropagation){var c=h.pointer(a,this.svg_this_pad().node());if(c&&2==c.length&&0<=c[0]&&10>c[0]&&0<=c[1]&&10>c[1])return;a.stopPropagation();a.preventDefault();
(c=this.getFramePainter())&&c.setLastEventPos()}f.createMenu(a,this).then(function(a){b.fillContextMenu(a);return b.fillObjectExecMenu(a,"")}).then(function(a){return a.show()})};e.prototype.redrawPad=function(a){var b=this,c=this.syncDraw(a);if(!1===c)return console.log("Prevent redrawing",this.pad.fName),Promise.resolve(!1);var d=!0,g=function(c){for(;c<b.painters.length;){var e=b.painters[c++],l=0;if(d||e.this_pad_name)l=e.redraw(a);if(f.isPromise(l))return l.then(function(){return g(c)})}return Promise.resolve(!0)};
return c.then(function(){b.iscan?b.createCanvasSvg(2):d=b.createPadSvg(!0);return g(0)}).then(function(){b.confirmDraw();if(f.getActivePad()===b){var a=b.getCanvPainter();a&&a.producePadEvent("padredraw",b)}return!0})};e.prototype.redraw=function(a){this.redrawPad(a)};e.prototype.needRedrawByResize=function(){var a=this.svg_this_pad();return a.empty()||a.property("can3d")!==JSROOT.constants.Embed3D.Overlay?0<=this.painters.findIndex(function(a){if("function"===typeof a.needRedrawByResize)return a.needRedrawByResize()}):
!0};e.prototype.checkCanvasResize=function(a,b){var c=this;if(!this.iscan&&this.has_canvas)return!1;var d=this.syncDraw("canvas_resize");if(!1===d)return!1;if(!0===a||!1===a)b=a,a=null;a&&"object"===typeof a&&a.force&&(b=!0);b||(b=this.needRedrawByResize());var g=!1,e=function(a){if(!g||a>=c.painters.length)return c.confirmDraw(),g;var d=c.painters[a].redraw(b?"redraw":"resize");f.isPromise(d)||(d=Promise.resolve());return d.then(function(){return e(a+1)})};return d.then(function(){g=c.createCanvasSvg(b?
2:1,a);return e(0)})};e.prototype.updateObject=function(a){if(!a)return!1;this.pad.fBits=a.fBits;this.pad.fTitle=a.fTitle;this.pad.fGridx=a.fGridx;this.pad.fGridy=a.fGridy;this.pad.fTickx=a.fTickx;this.pad.fTicky=a.fTicky;this.pad.fLogx=a.fLogx;this.pad.fLogy=a.fLogy;this.pad.fLogz=a.fLogz;this.pad.fUxmin=a.fUxmin;this.pad.fUxmax=a.fUxmax;this.pad.fUymin=a.fUymin;this.pad.fUymax=a.fUymax;this.pad.fX1=a.fX1;this.pad.fX2=a.fX2;this.pad.fY1=a.fY1;this.pad.fY2=a.fY2;this.pad.fLeftMargin=a.fLeftMargin;
this.pad.fRightMargin=a.fRightMargin;this.pad.fBottomMargin=a.fBottomMargin;this.pad.fTopMargin=a.fTopMargin;this.pad.fFillColor=a.fFillColor;this.pad.fFillStyle=a.fFillStyle;this.pad.fLineColor=a.fLineColor;this.pad.fLineStyle=a.fLineStyle;this.pad.fLineWidth=a.fLineWidth;this.pad.fPhi=a.fPhi;this.pad.fTheta=a.fTheta;this.iscan&&this.checkSpecialsInPrimitives(a);var b=this.getFramePainter();b&&b.updateAttributes(!b.modified_NDC);if(!a.fPrimitives)return!1;b=!1;for(var c=0,d=0;d<a.fPrimitives.arr.length;++d)for(;c<
this.painters.length;){var g=this.painters[c++];if(g._primitive){g.updateObject(a.fPrimitives.arr[d])&&(b=!0);break}}return b};e.prototype.addObjectPainter=function(a,b,c){if(a&&b&&b[c]&&void 0===a.snapid){var d=this.painters.indexOf(a);0>d&&this.painters.push(a);"function"==typeof a.setSnapId?a.setSnapId(b[c].fObjectID):a.snapid=b[c].fObjectID;a.$primary&&0<d&&this.painters[d-1].$secondary&&(this.painters[d-1].snapid=a.snapid+"#hist",console.log("ASSIGN SECONDARY HIST ID",this.painters[d-1].snapid))}};
e.prototype.drawNextSnap=function(a,b){var c=this;void 0===b&&(b=-1,this._snaps_map={},this._num_primitives=a?a.length:0);++b;if(!a||b>=a.length)return delete this._snaps_map,Promise.resolve(this);var d=a[b],g=d.fObjectID,l=this._snaps_map[g],h=null;l?l++:l=1;this._snaps_map[g]=l;for(var k=0;k<this.painters.length;++k)if(this.painters[k].snapid===g&&0===--l){h=this.painters[k];break}if(h){if(3===d.fKind)return h.redrawPadSnap(d).then(function(){return c.drawNextSnap(a,b)});var m;1===d.fKind?h.updateObject(d.fSnapshot,
d.fOption)&&(m=h.redraw()):2===d.fKind&&h.updateObject(d.fSnapshot)&&(m=h.redraw());f.isPromise(m)||(m=Promise.resolve(!0));return m.then(function(){return c.drawNextSnap(a,b)})}if(5===d.fKind)return JSROOT.extend(JSROOT.gStyle,d.fSnapshot),this.drawNextSnap(a,b);if(4===d.fKind){g=[];l=d.fSnapshot.fOper.split(";");for(h=0;h<l.length;++h)k=l[h],m=k.indexOf(":"),0<m?g[parseInt(k.substr(0,m))]="rgb("+k.substr(m+1)+")":(m=k.indexOf("="),g[parseInt(k.substr(0,m))]="rgba("+k.substr(m+1)+")");this.options&&
!this.options.GlobalColors||f.adoptRootColors(g);this.options&&this.options.LocalColors&&(this.root_colors=f.extendRootColors(null,g));if(d.fSnapshot.fBuf&&(!this.options||!this.options.IgnorePalette)){l=[];for(h=0;h<d.fSnapshot.fBuf.length;++h)l[h]=g[Math.round(d.fSnapshot.fBuf[h])];this.custom_palette=new JSROOT.ColorPalette(l)}return this.drawNextSnap(a,b)}if(3===d.fKind){g=d.fSnapshot;g.fPrimitives=null;var t=new e(this.getDom(),g,!1);t.decodeOptions(d.fOption);t.addToPadPrimitives(this.this_pad_name);
t.snapid=d.fObjectID;t.createPadSvg();t.matchObjectType("TPad")&&0<d.fPrimitives.length&&t.addPadButtons(!0);var n=t.selectCurrentPad(t.this_pad_name);return t.drawNextSnap(d.fPrimitives).then(function(){t.selectCurrentPad(n);return c.drawNextSnap(a,b)})}return 1===d.fKind||2===d.fKind?JSROOT.draw(this.getDom(),d.fSnapshot,d.fOption).then(function(d){c.addObjectPainter(d,a,b);return c.drawNextSnap(a,b)}):this.drawNextSnap(a,b)};e.prototype.findSnap=function(a){if(this.snapid===a)return this;if(!this.painters)return null;
...
var b=c.getMainPainter();b&&(a.add("X axis","xaxis",c.itemContextMenu),a.add("Y axis","yaxis",c.itemContextMenu),"function"===typeof b.getDimension&&1<b.getDimension()&&a.add("Z axis","zaxis",c.itemContextMenu));if(c.painters&&0<c.painters.length){a.add("separator");var d=[];c.painters.forEach(function(b,e){if((b=b?b.getObject():null)&&!(0<=d.indexOf(b))){var g="_typename"in b?b._typename+"::":"";"fName"in b&&(g+=b.fName);g.length||(g="item"+e);a.add(g,e,c.itemContextMenu)}})}a.show()});else{var d=
...
(a|=B);return a};m.prototype.produceJSON=function(){var a=this.getObject(),b=0==a.fFillStyle;b&&(a.fFillStyle=1001);this.normal_canvas||this.forEachPainterInPad(function(b){if(!b.$secondary){var c=b.getObject();c&&c._typename&&a.fPrimitives.Add(c,b.getDrawOpt())}},"objects");var c=JSROOT.toJSON(a);b&&(a.fFillStyle=0);this.normal_canvas||a.fPrimitives.Clear();return c};var S=function(a,b,c){var d=!b;d&&(b=JSROOT.create("TCanvas"));var e=new m(a,b);e.checkSpecialsInPrimitives(b);if(!d&&b.fCw&&b.fCh&&
!JSROOT.batch_mode){var h=e.selectDom().node().getBoundingClientRect();!h.height&&h.width>.1*b.fCw&&(e.selectDom().style("width",b.fCw+"px").style("height",b.fCh+"px"),e._fixed_size=!0)}e.decodeOptions(c);e.normal_canvas=!d;e.createCanvasSvg(0);e.addPadButtons();return(d&&0>c.indexOf("noframe")?P(a,null):Promise.resolve(!0)).then(function(){f.selectActivePad({pp:e,active:!0});return e.drawPrimitives()}).then(function(){e.showPadButtons();return e})};JSROOT.TAxisPainter=n;JSROOT.TFramePainter=k;JSROOT.TPadPainter=
e;JSROOT.TCanvasPainter=m;f.drawGaxis=function(a,b,c){var d=new n(a,b,!1);d.disable_zooming=!0;return f.ensureTCanvas(d,!1).then(function(){c&&d.convertTo(c);return d.redraw()})};f.drawFrame=P;f.drawPad=function(a,b,c){var d=new e(a,b,!1);d.decodeOptions(c);d.getCanvSvg().empty()?(d.has_canvas=!1,d.this_pad_name="",d.setTopPainter()):d.addToPadPrimitives(d.pad_name);d.createPadSvg();!d.matchObjectType("TPad")||d.has_canvas&&!d.hasObjectsToDraw()||d.addPadButtons();var g=d.has_canvas?d.selectCurrentPad(d.this_pad_name):
void 0;f.selectActivePad({pp:d,active:!0});return d.drawPrimitives().then(function(){d.showPadButtons();d.selectCurrentPad(g);return d})};f.drawCanvas=S;f.ensureTCanvas=function(a,b){if(!a)return Promise.reject("Painter not provided in ensureTCanvas");var c=a.getCanvSvg(),d=!1===b||"3d"==b?"noframe":"";return(c.empty()?S(a.getDom(),null,d):Promise.resolve(!0)).then(function(){if(!1!==b&&a.getFrameSvg().select(".main_layer").empty()&&!a.getFramePainter())return P(a.getDom(),null,"string"===typeof b?
b:"")}).then(function(){a.addToPadPrimitives();return a})};f.drawPadSnapshot=function(a,b){var c=JSROOT.create("TCanvas"),d=new m(a,c);d.normal_canvas=!1;d.addPadButtons();return d.syncDraw(!0).then(function(){return d.redrawPadSnap(b)}).then(function(){d.confirmDraw();d.showPadButtons();return d})};return JSROOT});
