...
function(b){return a(b)})});return c.then(function(a){return f(new d.PointsMaterial({size:3*b.scale,map:a,transparent:!0}),!0)})}return f(new d.PointsMaterial({size:3*this.scale,map:l.load(h),transparent:!0}))};f.PointsCreator=m;f.InteractiveControl=h;f.PointsControl=p;f.drawPolyLine3D=function(){var a=this.getObject(),b=this.getFramePainter();if(!b||!b.mode3d||!a)return null;if(!b.toplevel)return(b=this.getMainPainter())&&"function"==typeof b.drawExtras?b.drawExtras(a):null;var c=[];if(a._blob&&
4==a._blob.length){var d=a._blob[1];var g=a._blob[2]}else d=a.fN,g=a.fP;for(var h=3;h<3*d;h+=3)c.push(b.grx(g[h-3]),b.gry(g[h-2]),b.grz(g[h-1]),b.grx(g[h]),b.gry(g[h+1]),b.grz(g[h+2]));a=f.createLineSegments(c,v(this,a));b.toplevel.add(a);return!0};f.create3DLineMaterial=v;JSROOT.nodejs&&(module.exports=d);return d});
