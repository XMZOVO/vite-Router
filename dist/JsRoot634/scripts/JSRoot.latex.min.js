...
this.batch_;this.batch_=[];for(var e=0;e<a.length;++e){var f=a[e];a[e]=null;try{f()}catch(P){this.asyncThrow_(P)}}}this.batch_=null};n.prototype.asyncThrow_=function(a){this.asyncExecuteFunction(function(){throw a;})};var f=function(a){this.state_=0;this.result_=void 0;this.onSettledCallbacks_=[];var e=this.createResolveAndReject_();try{a(e.resolve,e.reject)}catch(O){e.reject(O)}};f.prototype.createResolveAndReject_=function(){function a(a){return function(E){f||(f=!0,a.call(e,E))}}var e=this,f=!1;
return{resolve:a(this.resolveTo_),reject:a(this.reject_)}};f.prototype.resolveTo_=function(a){if(a===this)this.reject_(new TypeError("A Promise cannot resolve to itself"));else if(a instanceof f)this.settleSameAsPromise_(a);else{a:switch(typeof a){case "object":var e=null!=a;break a;case "function":e=!0;break a;default:e=!1}e?this.resolveToNonPromiseObj_(a):this.fulfill_(a)}};f.prototype.resolveToNonPromiseObj_=function(a){var e=void 0;try{e=a.then}catch(O){this.reject_(O);return}"function"==typeof e?
...
this.onSettledCallbacks_=null}};var Q=new n;f.prototype.settleSameAsPromise_=function(a){var e=this.createResolveAndReject_();a.callWhenSettled_(e.resolve,e.reject)};f.prototype.settleSameAsThenable_=function(a,e){var f=this.createResolveAndReject_();try{a.call(e,f.resolve,f.reject)}catch(P){f.reject(P)}};f.prototype.then=function(a,e){function n(a,e){return"function"==typeof a?function(e){try{p(a(e))}catch(h){E(h)}}:e}var p,E,u=new f(function(a,e){p=a;E=e});this.callWhenSettled_(n(a,p),n(e,E));return u};
...
"#vec":"","#dot":"\u22c5","#hat":"\u00b7","#ddot":"","#acute":"","#grave":"","#check":"\u2713","#tilde":"\u02dc","#slash":"\u2044","#hbar":"\u0127","#box":"\u25fd","#Box":"\u2610","#parallel":"\u2225","#perp":"\u22a5","#odot":"\u2299","#left":"","#right":"","{}":""},Q=new RegExp("("+Object.keys(f).join("|").replace(/\\\{/g,"{").replace(/\\\}/g,"}")+")","g"),E=function(a,e){for(;2<a.length&&"{"==a[0]&&"}"==a[a.length-1];)a=a.substr(1,a.length-2);return a.replace(Q,function(a){return f[a]}).replace(/\{\}/g,
"")},e={};e.symbols_map=f;var O=[453,535,661,973,955,1448,1242,324,593,596,778,1011,431,570,468,492,947,885,947,947,947,947,947,947,947,947,511,495,980,1010,987,893,1624,1185,1147,1193,1216,1080,1028,1270,1274,531,910,1177,1004,1521,1252,1276,1111,1276,1164,1056,1073,1215,1159,1596,1150,1124,1065,540,591,540,837,874,572,929,972,879,973,901,569,967,973,453,458,903,453,1477,973,970,972,976,638,846,548,973,870,1285,884,864,835,656,430,656,1069],P={945:1002,946:996,967:917,948:953,949:834,966:1149,947:847,
...
c){var d=0,e=1,f=!1;b||(b="{");c||(c="}");var h=function(b){return d+b.length<=g.length&&g.substr(d,b.length)==b};for(a&&(h(b)?g=g.substr(b.length):f=!0);!f&&0!=e&&d<g.length;)h(b)?(e++,d+=b.length):h(c)?(e--,d+=c.length):d++;if(0!=e||f)return console.log("mismatch with open "+b+" and closing "+c+" in "+g),-1;a=g.substr(0,d-c.length);g=g.substr(d);return a},v=function(a,c){return a.append("svg:path").style("stroke",c?"none":b.color||e.color).style("stroke-width",c?null:Math.max(1,Math.round(b.fsize*
(b.font.weight?.1:.07)))).style("fill",c?b.color||e.color:"none")},r=function(a){return{lvl:b.lvl+1,x:0,y:0,fsize:b.fsize*(a||1),color:b.color,font:b.font,parent:b,painter:b.painter}},k={};g;){var t=g.length;k.$jscomp$loop$prop$found$53=null;for(var d=0;d<Y.length;++d){var u=g.indexOf(Y[d].name);0<=u&&u<t&&(t=u,k.$jscomp$loop$prop$found$53=Y[d])}if(0<t){var y=t==g.length&&0==c&&!k.$jscomp$loop$prop$found$53;c++;var O=E(g.substr(0,t));if(0<O.length||y){var z=(b.g||(y?a:f())).append("svg:text");y&&
!b.g&&(b.g=z);b.ufont&&b.font.setFont(b.g);void 0!==b.bold&&b.g.attr("font-weight",b.bold?"bold":"normal");void 0!==b.italic&&b.g.attr("font-style",b.italic?"italic":"normal");z.attr("fill",b.color||e.color||null);b.fisze!==b.font.size&&z.attr("font-size",Math.round(b.fsize));z.text(O);var A=JSROOT.nodejs||JSROOT.settings.ApproxTextSize||e.fast?{height:1.2*b.fsize,width:Oa(O,b.font,b.fsize)}:n.getElementRect(z,"nopadding");b.x&&z.attr("x",b.x);b.y&&z.attr("y",b.y);b.last_y1=b.y-.8*A.height;b.last_y2=
b.y+.2*A.height;x(b.x,b.last_y1,b.x+A.width,b.last_y2);y?b.deco&&(z.attr("text-decoration",b.deco),delete b.deco):h(A.width)}}if(!k.$jscomp$loop$prop$found$53)break;g=g.substr(t+k.$jscomp$loop$prop$found$53.name.length);c++;if(k.$jscomp$loop$prop$found$53.accent){var P=l();if(-1===P)return!1;var J=m(),W=r();B(J,e,P,W);var Q=.6*b.fsize,fa=0,Z=W.rect.width,F=Math.round(W.rect.y1),R=Math.round(.1*b.fsize),D=2*R,za="a"+R+","+R+",0,0,1,"+D+",0a"+R+","+R+",0,0,1,"+-D+",0z";k.$jscomp$loop$prop$found$53.hasw&&
Z<Q&&(Z=Q,fa=(Q-W.rect.width)/2);var K=Math.round(.5*Z),aa=Math.round(.3*Z),oa=K-aa,pa=K+aa;Z=2*K;p(W,fa,0,!0);switch(k.$jscomp$loop$prop$found$53.name){case "#check{":v(J).attr("d","M"+oa+","+(F-D)+"L"+K+","+F+"L"+pa+","+(F-D));break;case "#acute{":v(J).attr("d","M"+K+","+F+"l"+D+","+-D);break;case "#grave{":v(J).attr("d","M"+K+","+F+"l"+-D+","+-D);break;case "#dot{":v(J,!0).attr("d","M"+(K-R)+","+F+za);break;case "#ddot{":v(J,!0).attr("d","M"+(K-3*R)+","+F+za+" M"+(K+R)+","+F+za);break;case "#tilde{":v(J).attr("d",
"M"+oa+","+F+" a"+aa+","+D+",0,0,1,"+aa+",0 a"+aa+","+D+",0,0,0,"+aa+",0");break;case "#slash{":v(J).attr("d","M"+Z+","+F+"L0,"+Math.round(W.rect.y2));break;case "#vec{":v(J).attr("d","M"+oa+","+F+"H"+pa+"M"+(pa-D)+","+(F-D)+"l"+D+","+D+"l"+-D+","+D);break;default:v(J).attr("d","M"+oa+","+F+"L"+K+","+(F-D)+"L"+pa+","+F)}h(W.rect.width)}else if(k.$jscomp$loop$prop$found$53.twolines){b.twolines=!0;var Pa=l(),Qa=l(!0);if(-1===Pa||-1===Qa)return!1;var Aa=m(),Ra=b.parent&&b.parent.twolines?.7:1,ha=r(Ra);
B(Aa,e,Pa,ha);var Sa="line"==k.$jscomp$loop$prop$found$53.twolines?v(Aa):null,ia=r(Ra);B(Aa,e,Qa,ia);var Ta=Math.max(ha.rect.width,ia.rect.width),qa=ha.rect.width-ia.rect.width,Ba=.35*-b.fsize;p(ha,0>qa?-qa/2:0,Ba-ha.rect.y2,!0);p(ia,0<qa?qa/2:0,Ba-ia.rect.y1,!0);Sa&&Sa.attr("d","M0,"+Math.round(Ba)+"h"+Math.round(Ta-.1*b.fsize));h(Ta);delete b.twolines}else{var Ua=function(b){return function(a){var c={};if(a&&(c[a]=l(),-1===c[a]))return!1;for(;0<g.length;)if("_"==g.charAt(0)){if(g=g.substr(1),c.low=
c.low?-1:l(!0),-1===c.low)return console.log("error with "+b.$jscomp$loop$prop$found$53.name+" low limit"),!1}else if("^"==g.charAt(0)){if(g=g.substr(1),c.up=c.up?-1:l(!0),-1===c.up)return console.log("error with "+b.$jscomp$loop$prop$found$53.name+" upper limit"),!1}else break;return c}}(k);if(k.$jscomp$loop$prop$found$53.low_up){var ja=Ua(k.$jscomp$loop$prop$found$53.low_up);if(!ja)return!1;var ba=void 0,ca=void 0,Va=b.x,Wa=-b.fsize,Xa=.25*b.fsize,Ya=0,Za=0;ja.up&&(ba=r(.6),B(f(),e,ja.up,ba));ja.low&&
(ca=r(.6),B(f(),e,ja.low,ca));void 0!==b.last_y1&&void 0!==b.last_y2&&(Wa=b.last_y1,Xa=b.last_y2);ba&&(p(ba,Va,Wa-ba.rect.y1-.1*b.fsize),Ya=ba.rect.width);ca&&(p(ca,Va,Xa-ca.rect.y2+.1*b.fsize),Za=ca.rect.width);h(Math.max(Ya,Za))}else if(k.$jscomp$loop$prop$found$53.special){var ra=Ua(k.$jscomp$loop$prop$found$53.low_up)||{},Ca=m(),$a=v(Ca),L=Math.round(1.7*b.fsize),S=Math.round(b.fsize),M=Math.round(.1*L),Da=void 0,Ea=void 0;"#sum"==k.$jscomp$loop$prop$found$53.name?(Da=Ea=S/2,$a.attr("d","M"+S+
","+Math.round(-.75*L)+"h"+-S+"l"+Math.round(.4*S)+","+Math.round(.3*L)+"l"+Math.round(-.4*S)+","+Math.round(.7*L)+"h"+S)):(Da=3*M,Ea=M,$a.attr("d","M0,"+Math.round(.25*L-M)+"a"+M+","+M+",0,0,0,"+2*M+",0v"+(2*M-L)+"a"+M+","+M+",0,1,1,"+2*M+",0"));x(b.x,b.y-.6*L,b.x+S,b.y+.4*L);if(ra.low){var sa=r(.6);B(Ca,e,ra.low,sa);p(sa,Ea-sa.rect.width/2,.25*L-sa.rect.y1,!0)}if(ra.up){var ta=r(.6);B(Ca,e,ra.up,ta);p(ta,Da-ta.rect.width/2,-.75*L-ta.rect.y2,!0)}h(S)}else if(k.$jscomp$loop$prop$found$53.braces){var ab=
k.$jscomp$loop$prop$found$53.right,ya=l(!1,ab?k.$jscomp$loop$prop$found$53.name:"{",ab),Fa=m(),Ga=r(),ua=v(Fa);B(Fa,e,ya,Ga);var va=v(Fa),q=Math.max(2,Math.round(.2*b.fsize)),N=Ga.rect,G=Math.round(N.y2-N.y1),T=Math.round(N.y1),wa=Math.round(N.width);switch(k.$jscomp$loop$prop$found$53.braces){case "||":ua.attr("d","M"+q+","+T+"v"+G);va.attr("d","M"+(3*q+wa)+","+T+"v"+G);break;case "[]":ua.attr("d","M"+2*q+","+T+"h"+-q+"v"+G+"h"+q);va.attr("d","M"+(2*q+wa)+","+T+"h"+q+"v"+G+"h"+-q);break;case "{}":ua.attr("d",
"M"+2*q+","+T+" a"+q+","+q+",0,0,0,"+-q+","+q+" v"+(G/2-2*q)+" a"+q+","+q+",0,0,1,"+-q+","+q+" a"+q+","+q+",0,0,1,"+q+","+q+" v"+(G/2-2*q)+" a"+q+","+q+",0,0,0,"+q+","+q);va.attr("d","M"+(2*q+wa)+","+T+" a"+q+","+q+",0,0,1,"+q+","+q+" v"+(G/2-2*q)+" a"+q+","+q+",0,0,0,"+q+","+q+" a"+q+","+q+",0,0,0,"+-q+","+q+" v"+(G/2-2*q)+" a"+q+","+q+",0,0,1,"+-q+","+q);break;default:ua.attr("d","M"+q+","+T+"a"+4*G+","+4*G+",0,0,0,0,"+G),va.attr("d","M"+(3*q+wa)+","+T+"a"+4*G+","+4*G+",0,0,1,0,"+G)}p(Ga,2*q,0,
!0);x(b.x,b.y+N.y1,b.x+4*q+N.width,b.y+N.y2);h(4*q+N.width);b.last_y1=N.y1;b.last_y2=N.y2}else if(k.$jscomp$loop$prop$found$53.deco){var ib=l(),bb=m(),da=r();da.deco=k.$jscomp$loop$prop$found$53.deco;B(bb,e,ib,da);var ea=da.rect;if(da.deco){var Ha=v(bb),Ia=Math.round(ea.width);switch(da.deco){case "underline":Ha.attr("d","M0,"+Math.round(ea.y2)+"h"+Ia);break;case "overline":Ha.attr("d","M0,"+Math.round(ea.y1)+"h"+Ia);break;case "line-through":Ha.attr("d","M0,"+Math.round(.45*ea.y1+.55*ea.y2)+"h"+
Ia)}}p(da,0,0,!0);h(ea.width)}else if("#bf{"==k.$jscomp$loop$prop$found$53.name||"#it{"==k.$jscomp$loop$prop$found$53.name){var cb=l();if(-1===cb)return!1;var X=r();"#bf{"==k.$jscomp$loop$prop$found$53.name?X.bold=!X.bold:X.italic=!X.italic;B(f(),e,cb,X);p(X,b.x,b.y);h(X.rect.width)}else{var H=0;if(k.$jscomp$loop$prop$found$53.arg){var ka=g.indexOf("]{");if(0>ka)return console.log("missing argument for ",k.$jscomp$loop$prop$found$53.name),!1;H=g.substr(0,ka);if("int"==k.$jscomp$loop$prop$found$53.arg){if(H=
parseInt(H),!Number.isInteger(H))return console.log("wrong int argument",g.substr(0,ka)),!1}else if("float"==k.$jscomp$loop$prop$found$53.arg&&(H=parseFloat(H),!Number.isFinite(H)))return console.log("wrong float argument",g.substr(0,ka)),!1;g=g.substr(ka+2)}if("#kern["==k.$jscomp$loop$prop$found$53.name||"#lower["==k.$jscomp$loop$prop$found$53.name){var db=l();if(-1===db)return!1;var la=r();B(f(),e,db,la);var Ja=0,eb=0;"kern["==k.$jscomp$loop$prop$found$53.name?Ja=H:eb=H;p(la,b.x+Ja*la.rect.width,
b.y+eb*la.rect.height);h(la.rect.width*(0<Ja?1+H:1))}else if("#color["==k.$jscomp$loop$prop$found$53.name||"#scale["==k.$jscomp$loop$prop$found$53.name||"#font["==k.$jscomp$loop$prop$found$53.name){var fb=l();if(-1===fb)return!1;var U=r();"#color["==k.$jscomp$loop$prop$found$53.name?U.color=b.painter.getColor(H):"#font["==k.$jscomp$loop$prop$found$53.name?(U.font=new JSROOT.FontHandler(H),U.ufont=!0):U.fsize*=H;B(f(),e,fb,U);p(U,b.x,b.y);h(U.rect.width)}else if(k.$jscomp$loop$prop$found$53.sqrt){var gb=
l();if(-1===gb)return!1;var Ka=m(),ma=void 0,La=r();k.$jscomp$loop$prop$found$53.arg&&(ma=r(.7),B(Ka,e,H.toString(),ma));var jb=v(Ka);B(Ka,e,gb,La);var V=La.rect,na=Math.round(V.height),xa=Math.round(.1*V.height),Ma=Math.round(V.width),Na=Math.round((V.y1+V.y2)/2),hb=Math.round(.2*b.fsize),kb=Math.round(V.y2);ma&&p(ma,0,Na-.3*ma.fsize,!0);jb.attr("d","M0,"+Na+"h"+xa+"l"+xa+","+(kb-Na-hb)+"l"+xa+","+(-na+hb)+"h"+Math.round(.2*na+Ma)+"v"+xa);p(La,.4*na,0,!0);x(b.x,b.y+V.y1-.1*b.fsize,b.x+Ma+.6*na,b.y+
V.y2);h(Ma+.6*na)}}}k={$jscomp$loop$prop$found$53:k.$jscomp$loop$prop$found$53}}return!0};e.produceLatex=function(a,e,g){return B(e,g,g.text,{lvl:0,g:e,x:0,y:0,dx:0,dy:-.1,fsize:g.font_size,font:g.font,parent:null,painter:a})};e.loadMathjax=function(){var a=void 0!==e._mj_loading;if(!a&&"undefined"!=typeof MathJax)return Promise.resolve(MathJax);a||(e._mj_loading=[]);var f=new Promise(function(a){e._mj_loading?e._mj_loading.push(a):a(MathJax)});if(a)return f;var g={scale:1,minScale:.5,mtextInheritFont:!1,
merrorInheritFont:!0,mathmlSpacing:!1,skipAttributes:{},exFactor:.5,displayAlign:"center",displayIndent:"0",fontCache:"local",localID:null,internalSpeechTitles:!0,titleID:0};JSROOT.nodejs||(window.MathJax={options:{enableMenu:!1},loader:{load:["[tex]/color"]},tex:{packages:{"[+]":["color"]}},svg:g,startup:{ready:function(){MathJax.startup.defaultReady();var a=e._mj_loading;delete e._mj_loading;a.forEach(function(a){return a(MathJax)})}}});JSROOT.require("mathjax").then(function(a){JSROOT.nodejs&&
a.init({loader:{load:["input/tex","output/svg","[tex]/color"]},tex:{packages:{"[+]":["color"]}},svg:g,config:{JSDOM:require("jsdom").JSDOM},startup:{typeset:!1,ready:function(){MathJax.startup.registerConstructor("jsdomAdaptor",function(){return new MathJax._.adaptors.HTMLAdaptor.HTMLAdaptor((new MathJax.config.config.JSDOM).window)});MathJax.startup.useAdaptor("jsdomAdaptor",!0);MathJax.startup.defaultReady();var a=e._mj_loading;delete e._mj_loading;a.forEach(function(a){return a(MathJax)})}}})});
return f};var fa={"#LT":"\\langle","#GT":"\\rangle","#club":"\\clubsuit","#spade":"\\spadesuit","#heart":"\\heartsuit","#diamond":"\\diamondsuit","#voidn":"\\wp","#voidb":"f","#copyright":"(c)","#ocopyright":"(c)","#trademark":"TM","#void3":"TM","#oright":"R","#void1":"R","#3dots":"\\ldots","#lbar":"\\mid","#void8":"\\mid","#divide":"\\div","#Jgothic":"\\Im","#Rgothic":"\\Re","#doublequote":'"',"#plus":"+","#minus":"-","#/":"/","#upoint":".","#aa":"\\mathring{a}","#AA":"\\mathring{A}","#omicron":"o",
"#Alpha":"A","#Beta":"B","#Epsilon":"E","#Zeta":"Z","#Eta":"H","#Iota":"I","#Kappa":"K","#Mu":"M","#Nu":"N","#Omicron":"O","#Rho":"P","#Tau":"T","#Chi":"X","#varomega":"\\varpi","#corner":"?","#ltbar":"?","#bottombar":"?","#notsubset":"?","#arcbottom":"?","#cbar":"?","#arctop":"?","#topbar":"?","#arcbar":"?","#downleftarrow":"?","#splitline":"\\genfrac{}{}{0pt}{}","#it":"\\textit","#bf":"\\textbf","#frac":"\\frac","#left{":"\\lbrace","#right}":"\\rbrace","#left\\[":"\\lbrack","#right\\]":"\\rbrack",
"#\\[\\]{":"\\lbrack"," } ":"\\rbrack","#\\[":"\\lbrack","#\\]":"\\rbrack","#{":"\\lbrace","#}":"\\rbrace"," ":"\\;"},ya=function(a,e,g,b){if(2!=e){for(var c in fa)a=a.replace(new RegExp(c,"g"),fa[c]);for(var h in f)2<h.length&&(a=a.replace(new RegExp(h,"g"),"\\"+h.substr(1)));e="";for(c=!0;a;){h=a.indexOf("#color[");if(0>h&&c){e=a;break}c=!1;if(0!=h){var p=0>h?a:a.substr(0,h);e+=p;if(0>h)break}a=a.substr(h+7);h=a.indexOf("]{");if(0>=h)break;p=parseInt(a.substr(0,h));if(!Number.isInteger(p))break;
p=b.getColor(p);var n=1;a=a.substr(h+2);for(h=-1;n&&++h<a.length;)"{"==a[h]?n++:"}"==a[h]&&n--;if(0!=n)break;n=a.substr(0,h);a=a.substr(h+1);n&&(e+="\\color{"+p+"}{"+n+"}")}a=e}else a=a.replace(/\\\^/g,"\\hat");return"string"!=typeof g?a:"\\color{"+g+"}{"+a+"}"};e.produceMathjax=function(f,n,g){var b=ya(g.text,g.latex,g.color,f),c={em:g.font.size,ex:g.font.size/2,family:g.font.name,scale:1,containerWidth:-1,lineWidth:1E5};return e.loadMathjax().then(function(){return MathJax.tex2svgPromise(b,c)}).then(function(b){var c=
a.select(b).select("svg");n.append(function(){return c.node()});p(f,n,c,g);g.applyAttributesToMathJax=u;return!0})};e.typesetMathjax=function(a){return e.loadMathjax().then(function(){return MathJax.typesetPromise(a?[a]:void 0)})};JSROOT.nodejs&&(module.exports=e);return e});
