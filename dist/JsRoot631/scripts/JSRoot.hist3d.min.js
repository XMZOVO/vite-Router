...
0,a=2*this.size_3d),b[this.zoom]<c?b[this.zoom]=c:b[this.zoom]>a&&(b[this.zoom]=a),b}};c.showSelection=function(a,b){var c=this.children?this.children[0]:null,d=this.zoom;if(!a||!b)return c&&(this.remove(c),g.disposeThreejsObject(c)),c;if(c)var f=c.geometry;else f=this.geometry.clone(),c=f.getAttribute("position").array,"z"===d?c[6]=c[3]=c[15]=h:c[4]=c[16]=c[13]=-h,c=new e.Mesh(f,new e.MeshBasicMaterial({color:65280,side:e.DoubleSide})),this.add(c);c=f.getAttribute("position").array;"z"==d?(c[2]=
c[11]=c[8]=a[d],c[5]=c[17]=c[14]=b[d]):(c[0]=c[9]=c[12]=a[d],c[6]=c[3]=c[15]=b[d]);f.getAttribute("position").needsUpdate=!0;f.computeFaceNormals();return!0};return c};var J=new e.Object3D;J.position.set(0,E,m);J.rotation.x=.25*Math.PI;J.xyid=2;a=g.createLineSegments(a,k);J.add(a);f.forEach(function(a){var c=a.boundingBox.max.x-a.boundingBox.min.x,d=a.center?a.grx-c/2:b-c;c=new e.Matrix4;c.set(x,0,0,d,0,x,0,(-B*x-1.5*h)*(a.gry||1),0,0,1,0,0,0,0,1);a=new e.Mesh(a,y);a.applyMatrix4(c);J.add(a)});c.zoom&&
J.add(z("x",this.size_x3d));q.add(J);J=new e.Object3D;J.position.set(0,R,m);J.rotation.x=.75*Math.PI;J.add(new e.LineSegments(a.geometry,k));f.forEach(function(a){var c=a.boundingBox.max.x-a.boundingBox.min.x,d=a.center?a.grx+c/2:b;c=new e.Matrix4;c.set(-x,0,0,d,0,x,0,(-B*x-1.5*h)*(a.gry||1),0,0,-1,0,0,0,0,1);a=new e.Mesh(a,y);a.applyMatrix4(c);J.add(a)});J.xyid=4;c.zoom&&J.add(z("x",this.size_x3d));q.add(J);f=[];x=1;B=0;a=[];for(v=this.yaxis;l.next();)w=l.grpos,r=1===l.kind,A=this.y_handle.format(l.tick,
2),l.last_major()?v&&v.fTitle||(A="y"):null===A&&(r=!1,A=""),r&&(A=new e.TextGeometry(A,{font:JSROOT.threejs_font_helvetiker_regular,size:p,height:0,curveSegments:5}),A.computeBoundingBox(),I=A.boundingBox.max.x-A.boundingBox.min.x,n=A.boundingBox.max.y-A.boundingBox.min.y,A.center=!0,B=Math.max(B,n),A.gry=w,f.push(A),l.last_major()||(n=l.next_major_grpos()-w,0<I&&(x=Math.min(x,.9*n/I)),this.y_handle.isCenteredLabels()&&(A.gry+=n/2))),a.push(0,w,0,r?-h:.6*-h,w,0);v&&v.fTitle&&(l=new e.TextGeometry(M.translateLaTeX(v.fTitle),
{font:JSROOT.threejs_font_helvetiker_regular,size:p,height:0,curveSegments:5}),l.computeBoundingBox(),l.center=v.TestBit(JSROOT.EAxisBits.kCenterTitle),l.grx=2,l.gry=(E+R)/2,f.push(l));if(!c.use_y_for_z){a=g.createLineSegments(a,k);var D=new e.Object3D;D.position.set(d,0,m);D.rotation.y=-.25*Math.PI;D.add(a);f.forEach(function(a){var c=a.boundingBox.max.x-a.boundingBox.min.x,b=a.center?a.gry+c/2:R;c=new e.Matrix4;c.set(0,x,0,(-B*x-1.5*h)*(a.grx||1),-x,0,0,b,0,0,1,0,0,0,0,1);a=new e.Mesh(a,y);a.applyMatrix4(c);
D.add(a)});D.xyid=3;c.zoom&&D.add(z("y",this.size_y3d));q.add(D);D=new e.Object3D;D.position.set(b,0,m);D.rotation.y=-.75*Math.PI;D.add(new e.LineSegments(a.geometry,k));f.forEach(function(a){var c=a.boundingBox.max.x-a.boundingBox.min.x,b=a.center?a.gry-c/2:R-c;c=new e.Matrix4;c.set(0,x,0,(-B*x-1.5*h)*(a.grx||1),x,0,0,b,0,0,-1,0,0,0,0,1);a=new e.Mesh(a,y);a.applyMatrix4(c);D.add(a)});D.xyid=1;c.zoom&&D.add(z("y",this.size_y3d));q.add(D)}f=[];x=1;a=[];A=w=r=null;l=this.zaxis;v=0;this.size_z3d&&(r=
[],w=[]);for(;t.next();){I=t.grpos;n=1==t.kind;var H=this.z_handle.format(t.tick,2);null===H&&(n=!1,H="");if(n&&H){H=new e.TextGeometry(H,{font:JSROOT.threejs_font_helvetiker_regular,size:p,height:0,curveSegments:5});H.computeBoundingBox();var F=H.boundingBox.max.x-H.boundingBox.min.x,C=H.boundingBox.max.y-H.boundingBox.min.y;H.translate(-F,-C/2,0);H.grz=I;f.push(H);null!==A&&0<C&&(x=Math.min(x,.9*(I-A)/C));v=Math.max(v,F);A=I}r&&n&&r.push(d,0,I,b,0,I);w&&n&&w.push(0,E,I,0,R,I);a.push(0,0,I,n?h:.6*
h,0,I)}r&&0<r.length&&(t=new e.LineDashedMaterial({color:0,dashSize:2,gapSize:2}),r=g.createLineSegments(r,t),r.position.set(0,R,0),r.grid=2,r.visible=!1,q.add(r),t=new e.LineSegments(r.geometry,t),t.position.set(0,E,0),t.grid=4,t.visible=!1,q.add(t));w&&0<w.length&&(t=new e.LineDashedMaterial({color:0,dashSize:2,gapSize:2}),w=g.createLineSegments(w,t),w.position.set(b,0,0),w.grid=3,w.visible=!1,q.add(w),t=new e.LineSegments(w.geometry,t),t.position.set(d,0,0),t.grid=1,t.visible=!1,q.add(t));var G=
[];a=g.createLineSegments(a,k);for(t={$jscomp$loop$prop$n$66:0};4>t.$jscomp$loop$prop$n$66;t={$jscomp$loop$prop$n$66:t.$jscomp$loop$prop$n$66},++t.$jscomp$loop$prop$n$66)G.push(new e.Object3D),f.forEach(function(a){return function(c){var b=new e.Matrix4;b.set(-x,0,0,2*h,0,0,1,0,0,x,0,c.grz);c=new e.Mesh(c,y);c.applyMatrix4(b);G[a.$jscomp$loop$prop$n$66].add(c)}}(t)),l&&l.fTitle&&(w=new e.TextGeometry(M.translateLaTeX(l.fTitle),{font:JSROOT.threejs_font_helvetiker_regular,size:p,height:0,curveSegments:5}),
w.computeBoundingBox(),r=w.boundingBox.max.x-w.boundingBox.min.x,A=l.TestBit(JSROOT.EAxisBits.kCenterTitle)?(u+m-r)/2:u-r,w.rotateZ(Math.PI/2),r=new e.Matrix4,r.set(-x,0,0,3*h+v,0,0,1,0,0,x,0,A),w=new e.Mesh(w,y),w.applyMatrix4(r),G[t.$jscomp$loop$prop$n$66].add(w)),G[t.$jscomp$loop$prop$n$66].add(0==t.$jscomp$loop$prop$n$66?a:new e.LineSegments(a.geometry,k)),c.zoom&&G[t.$jscomp$loop$prop$n$66].add(z("z",this.size_z3d,c.use_y_for_z)),G[t.$jscomp$loop$prop$n$66].zid=t.$jscomp$loop$prop$n$66+2,q.add(G[t.$jscomp$loop$prop$n$66]);
G[0].position.set(d,R,0);G[0].rotation.z=.75*Math.PI;G[1].position.set(b,R,0);G[1].rotation.z=.25*Math.PI;G[2].position.set(b,E,0);G[2].rotation.z=-.25*Math.PI;G[3].position.set(d,E,0);G[3].rotation.z=-.75*Math.PI;if(0!==this.size_z3d){c=g.createLineSegments([d,0,0,b,0,0],k,null,!0);for(p=0;2>p;++p)f=new e.LineSegments(c,k),f.position.set(0,E,0===p?m:u),f.xyboxid=2,f.bottom=0==p,q.add(f),f=new e.LineSegments(c,k),f.position.set(0,R,0===p?m:u),f.xyboxid=4,f.bottom=0==p,q.add(f);E=g.createLineSegments([0,
E,0,0,R,0],k,null,!0);for(c=0;2>c;++c)p=new e.LineSegments(E,k),p.position.set(d,0,0===c?m:u),p.xyboxid=3,p.bottom=0==c,q.add(p),p=new e.LineSegments(E,k),p.position.set(b,0,0===c?m:u),p.xyboxid=1,p.bottom=0==c,q.add(p);d=g.createLineSegments([0,0,m,0,0,u],k,null,!0);for(m=0;4>m;++m)u=new e.LineSegments(d,k),u.zboxid=G[m].zid,u.position.copy(G[m].position),q.add(u)}};JSROOT.THistPainter.prototype.draw3DBins=function(){var a=this;if(this.draw_content){if(this.isTH2Poly()&&this.drawPolyLego)return this.drawPolyLego();
if(2==this.getDimension()&&this.options.Contour&&this.drawContour3D)return this.drawContour3D(!0);if(2==this.getDimension()&&this.options.Surf&&this.drawSurf)return this.drawSurf();if(2==this.getDimension()&&this.options.Error&&this.drawError)return this.drawError();var c=g.Box3D.Vertices,d=g.Box3D.Indexes,b=g.Box3D.Normals,E=g.Box3D.Segments,R=[0,1,1,2,2,3,3,0],m=[new e.Vector3(0,0,0),new e.Vector3(0,1,0),new e.Vector3(1,1,0),new e.Vector3(1,0,0)],u=this.getFramePainter(),p=u.z_handle.getScaleMin(),
k=u.z_handle.getScaleMax(),q=this.prepareColorDraw({rounding:!1,use3d:!0,extra:1}),f=q.i1,z=q.i2,t=q.j1,l=q.j2,v=this.getHisto(),w=v?v.$baseh:null,r=11===this.options.Lego||13===this.options.Lego,y=65535>v.getBin(z,l);if(!(f>=z||t>=l)){var h,x,B,A,I,Z,J=function(c,b,d){I=v.getBinContent(c+1,b+1);A=w?w.getBinContent(c+1,b+1):!1!==a.options.BaseLine?a.options.BaseLine:a.options.Zero?p:0;I<A&&(c=A,A=I,I=c);if(A>=G||I<C)return!1;Z=I===C||A>=I;return!Z||0<d?!0:w?!1:a.options.Zero||0<p?!0:a._show_empty_bins},
D=[p,k],H=null;if(12===this.options.Lego||14===this.options.Lego)D=this.createContour(v.fContour?v.fContour.length:20,u.lego_zmin,u.lego_zmax).arr,H=this.getHistPalette();for(var F=0;F<D.length-1;++F){var C=D[F];var G=D[F+1];H&&F==D.length-2&&G<k&&(G=k);var K=0,L=0,N=B=0,M=u.grz(C),O=u.grz(G);for(h=f;h<z;++h)for(x=t;x<l;++x)if(J(h,x,F)){var T=!Z&&0<F;var W=!Z&&I>G&&F<D.length-2;B+=Z?12:d.length;T&&(B-=6);W&&(B-=6);r&&!Z&&(B-=12,N+=12)}var aa=new Float32Array(3*B),X=new Float32Array(3*B),S=y?new Uint16Array(B/
3):new Uint32Array(B/3);var Q=0===N?null:new Float32Array(3*N);var U=0===N?null:new Float32Array(3*N),P=0===N?null:y?new Uint16Array(N/3):new Uint32Array(N/3),V=0,ea=0,fa=T=void 0,ca=void 0;for(h=f;h<z;++h){B=q.grx[h]+q.xbar1*(q.grx[h+1]-q.grx[h]);var Y=q.grx[h]+q.xbar2*(q.grx[h+1]-q.grx[h]);for(x=t;x<l;++x)if(J(h,x,F)){T=!Z&&0<F;W=!Z&&I>G&&F<D.length-2;var ha=q.gry[x]+q.ybar1*(q.gry[x+1]-q.gry[x]);var ka=q.gry[x]+q.ybar2*(q.gry[x+1]-q.gry[x]);K=A<=C?M:u.grz(A);L=I>G?O:u.grz(I);fa=ca=0;Z&&(ca+=12,
fa+=24);var la=d.length,ma=v.getBin(h+1,x+1);for(T&&(la-=6);fa<la;)T=c[d[fa]],r&&12>fa?(Q[ea]=B+T.x*(Y-B),Q[ea+1]=ha+T.y*(ka-ha),Q[ea+2]=K+T.z*(L-K),U[ea]=b[ca],U[ea+1]=b[ca+1],U[ea+2]=b[ca+2],0===ea%9&&(P[ea/9]=ma),ea+=3):(aa[V]=B+T.x*(Y-B),aa[V+1]=ha+T.y*(ka-ha),aa[V+2]=K+T.z*(L-K),X[V]=b[ca],X[V+1]=b[ca+1],X[V+2]=b[ca+2],0===V%9&&(S[V/9]=ma),V+=3),++fa,0===fa%6&&(ca+=3,W&&fa===d.length-12&&(fa+=6,ca+=3))}}h=new e.BufferGeometry;h.setAttribute("position",new e.BufferAttribute(aa,3));h.setAttribute("normal",
new e.BufferAttribute(X,3));x=v.fFillColor;B=this.getColor(x);if(H)B=H.calcColor(F,D.length);else if(1===this.options.Lego||2>x)x=1,B="white";Y=new e.MeshBasicMaterial({color:B});h=new e.Mesh(h,Y);h.face_to_bins_index=S;h.painter=this;h.zmin=p;h.zmax=k;h.baseline=!1!==this.options.BaseLine?this.options.BaseLine:this.options.Zero?p:0;h.tip_color=3===x?16711680:65280;h.handle=q;h.tooltip=function(a){if(!Number.isInteger(a.faceIndex))return console.error("faceIndex not provided, three.js version "+e.REVISION+
", expected 127"),null;if(0>a.faceIndex||a.faceIndex>=this.face_to_bins_index.length)return null;var c=this.painter,b=this.handle,d=c.getFramePainter(),f=c.getHisto();a=c.get3DToolTip(this.face_to_bins_index[a.faceIndex]);a.x1=Math.max(-d.size_x3d,b.grx[a.ix-1]+b.xbar1*(b.grx[a.ix]-b.grx[a.ix-1]));a.x2=Math.min(d.size_x3d,b.grx[a.ix-1]+b.xbar2*(b.grx[a.ix]-b.grx[a.ix-1]));a.y1=Math.max(-d.size_y3d,b.gry[a.iy-1]+b.ybar1*(b.gry[a.iy]-b.gry[a.iy-1]));a.y2=Math.min(d.size_y3d,b.gry[a.iy-1]+b.ybar2*(b.gry[a.iy]-
b.gry[a.iy-1]));b=this.baseline;var k=a.value;f.$baseh&&(b=f.$baseh.getBinContent(a.ix,a.iy));k<b&&(f=b,b=k,k=f);a.z1=d.grz(Math.max(this.zmin,b));a.z2=d.grz(Math.min(this.zmax,k));a.color=this.tip_color;c.is_projection&&2==c.getDimension()&&(a.$painter=c);return a};u.toplevel.add(h);0<N&&(Y=new e.BufferGeometry,Y.setAttribute("position",new e.BufferAttribute(Q,3)),Y.setAttribute("normal",new e.BufferAttribute(U,3)),x=2>x?new e.Color(16711680):new e.Color(n.rgb(B).darker(.5).toString()),x=new e.MeshBasicMaterial({color:x}),
x=new e.Mesh(Y,x),x.face_to_bins_index=P,x.painter=this,x.handle=h.handle,x.tooltip=h.tooltip,x.zmin=h.zmin,x.zmax=h.zmax,x.baseline=h.baseline,x.tip_color=h.tip_color,u.toplevel.add(x))}if(!(12<this.options.Lego)){B=Y=0;G=k;C=p;for(h=f;h<z;++h)for(x=t;x<l;++x)J(h,x,0)&&(Y+=Z?m.length:c.length,B+=Z?R.length:E.length);(d=65520>=Y)||(Y=3*B);b=new Float32Array(3*Y);r=d?new Uint16Array(B):null;y=u.grz(p);D=u.grz(k);N=P=F=H=0;for(h=f;h<z;++h)for(B=q.grx[h]+q.xbar1*(q.grx[h+1]-q.grx[h]),Y=q.grx[h]+q.xbar2*
(q.grx[h+1]-q.grx[h]),x=t;x<l;++x)if(J(h,x,0))if(ha=q.gry[x]+q.ybar1*(q.gry[x+1]-q.gry[x]),ka=q.gry[x]+q.ybar2*(q.gry[x+1]-q.gry[x]),H=A<=p?y:u.grz(A),F=I>k?D:u.grz(I),U=Z?R:E,S=Z?m:c,d){for(f=0;f<U.length;++f)r[N++]=P/3+U[f];for(f=0;f<S.length;++f)Q=S[f],b[P]=B+Q.x*(Y-B),b[P+1]=ha+Q.y*(ka-ha),b[P+2]=H+Q.z*(F-H),P+=3}else for(f=0;f<U.length;++f)Q=S[U[f]],b[P]=B+Q.x*(Y-B),b[P+1]=ha+Q.y*(ka-ha),b[P+2]=H+Q.z*(F-H),P+=3;c=this.getColor(v.fLineColor);c=new e.LineBasicMaterial({color:new e.Color(c),linewidth:v.fLineWidth});
c=g.createLineSegments(b,c,d?r:null);u.toplevel.add(c)}}}};g.drawAxis3D=function(a,c){a=new JSROOT.ObjectPainter(a,c);"_main"in c||a.addToPadPrimitives();a.Draw3DAxis=function(){var a=this.getFramePainter();if(!a||!a._toplevel)return Promise.reject(Error("no 3D frame found for 3D axis drawing"));var b=(new e.Box3).setFromObject(a._toplevel);this.xmin=b.min.x;this.xmax=b.max.x;this.ymin=b.min.y;this.ymax=b.max.y;this.zmin=b.min.z;this.zmax=b.max.z;this.size_x3d=this.size_y3d=this.size_z3d=0;this.drawXYZ=
JSROOT.TFramePainter.prototype.drawXYZ;this.drawXYZ(a._toplevel);a.adjustCameraPosition();a.render3D();return Promise.resolve(this)};return a.Draw3DAxis()};JSROOT.TH1Painter.prototype.draw3D=function(a){var c=this;this.mode3d=!0;var d=this.getFramePainter(),b=this.isMainPainter(),e=this.getHisto();"resize"==a?b&&d.resize3D()&&d.render3D():(this.deleteAttr(),this.scanContent(!0),b&&(d.create3DScene(this.options.Render3D,this.options.x3dscale,this.options.y3dscale),d.setAxesRanges(e.fXaxis,this.xmin,
this.xmax,e.fYaxis,this.ymin,this.ymax,e.fZaxis,0,0),d.set3DOptions(this.options),d.drawXYZ(d.toplevel,{use_y_for_z:!0,zmult:1.1,zoom:JSROOT.settings.Zooming,ndim:1})),d.mode3d&&(this.draw3DBins(),d.render3D(),this.updateStatWebCanvas(),d.addKeysHandler()));return b?this.drawColorPalette(this.options.Zscale&&(12===this.options.Lego||14===this.options.Lego)).then(function(){return c.drawHistTitle()}):Promise.resolve(this)};JSROOT.TH2Painter.prototype.draw3D=function(a){var c=this;this.mode3d=!0;var d=
