...
e._childs[g];k._parent=e;if(!this.addItemHtml(k,d,g))break}}else{k=g;for(var t=void 0;k&&void 0===(t=k._click_action);)k=k._parent;b&&""!=b||(b="item");var p=n.getDrawSettings(g._kind);k=p.handle;if("icon"==b)e=null,"function"==typeof g._icon_click?e=g._icon_click:k&&"function"==typeof k.icon_click&&(e=k.icon_click),e&&e(g,this)&&this.updateTreeNode(g,d);else{"item"==b&&"_expand"in g&&!a.ctrlKey&&!a.shiftKey&&(b="plusminus");if("plusminus"==b&&!("_childs"in g)&&g._more||"item"==b&&"expand"===t)return this.expandItem(e,
d);if("item"==b){if("_player"in g)return this.player(e);if(k&&k.aslink)return window.open(e+"/");if(k&&k.execute)return this.executeCommand(e,c.parentNode);if(k&&k.ignore_online&&this.isOnlineItem(g))return;c=g._can_draw;b=g._more;t="expand"===this.default_by_click;var q="";a.shiftKey&&(q=k&&k.shift?k.shift:"inspect","inspect"===q&&k&&k.noinspect&&(q=""));k&&k.ctrl&&a.ctrlKey&&(q=k.ctrl);if(!q)for(a=g._parent;a;a=a._parent)if(a._painter){c=!1;void 0===b&&(b=!1);break}g._childs&&(b=!1);void 0===c&&
(c=p.draw);void 0===b&&(b=p.expand);c&&b&&!q&&(t||k&&"expand"===k.dflt||this.isItemDisplayed(e))&&(c=!1);c&&!q&&k&&k.dflt&&"expand"!==k.dflt&&(q=k.dflt);if(c)return this.display(e,q);if(b||t)return this.expandItem(e,d);if("string"===typeof g._kind&&0===g._kind.indexOf("ROOT.")&&p.inspect&&!1!==c)return this.display(e,"inspect");if(!g._childs||g===this.h)return}g._isopen?delete g._isopen:g._isopen=!0;this.updateTreeNode(g,d)}}}};l.prototype.tree_mouseover=function(a,b){b=f.select(b.parentNode.parentNode).attr("item");
var c=this.findItem(b);if(c){for(var d,h=c;h&&!d;)d=h._painter,h=h._parent;d&&"function"===typeof d.mouseOverHierarchy&&d.mouseOverHierarchy(a,b,c)}};l.prototype.direct_contextmenu=function(a,b){var c=this;a.preventDefault();var d=f.select(b.parentNode.parentNode).attr("item"),h=this.findItem(d);h&&"function"==typeof this.fill_context&&n.createMenu(a,this).then(function(a){c.fill_context(a,h);0<a.size()&&(a.tree_node=b.parentNode,a.show())})};l.prototype.tree_contextmenu=function(a,b){function c(a){var b=
document.createElement("div");b.innerHTML='<a href="'+a.split("&").join("&amp;").split("<").join("&lt;").split('"').join("&quot;")+'">x</a>';return b.firstChild.href}var d=this;a.preventDefault();var h=f.select(b.parentNode.parentNode).attr("item"),g=this.findItem(h);if(g){var k=this.getOnlineProp(h),t=this.getFileProp(h);n.createMenu(a,this).then(function(a){if(""!=h&&g._parent||"_jsonfile"in g)if(k)d.fillOnlineMenu(a,k,h);else{var e=n.getDrawSettings(g._kind,"nosame");g._can_draw&&(e.opts||(e.opts=
[""]),0>e.opts.indexOf("")&&e.opts.unshift(""));e.opts&&a.addDrawMenu("Draw",e.opts,function(a){return d.display(h,a)});if(t&&e.opts&&!t.localfile){var f=c(t.fileurl);0==f.indexOf(JSROOT.source_dir)&&(f=f.slice(JSROOT.source_dir.length));f=t.kind+"="+f;if(0<t.itemname.length){var p=t.itemname;0<=p.search(/\+| |,/)&&(p="'"+p+"'");f+="&item="+p}a.addDrawMenu("Draw in new tab",e.opts,function(a){return window.open(JSROOT.source_dir+"index.htm?nobrowser&"+f+"&opt="+a)})}!e.expand||"_childs"in g||!g._more&&
"_more"in g||a.add("Expand",function(){return d.expandItem(h)});"ROOT.TStyle"===g._kind&&a.add("Apply",function(){return d.applyStyle(h)})}else{var m=[],l="",w=0;e=function(){return 0<w++?"&":"?"};d.forEachRootFile(function(a){return m.push(a._file.fFullURL)});d.getTopOnlineItem()||(l=JSROOT.source_dir+"index.htm");d.isMonitoring()&&(l+=e()+"monitoring="+d.getMonitoringInterval());1==m.length?l+=e()+"file="+m[0]:1<m.length&&(l+=e()+"files="+JSON.stringify(m));d.disp_kind&&(l+=e()+"layout="+d.disp_kind.replace(/ /g,
""));var v=[],r=[];d.disp&&d.disp.forEachPainter(function(a){var b=a.getItemName();b&&(v.push(b),r.push(a.getDrawOpt()||a.getItemDrawOpt()))});1==v.length?l+=e()+"item="+v[0]+e()+"opt="+r[0]:1<v.length&&(l+=e()+"items="+JSON.stringify(v)+e()+"opt="+JSON.stringify(r));a.add("Direct link",function(){return window.open(l)});a.add("Only items",function(){return window.open(l+"&nobrowser")})}"function"==typeof g._menu&&g._menu(a,g,d);0<a.size()&&(a.tree_node=b.parentNode,a.separ&&a.add("separator"),a.add("Close"),
a.show())});return!1}};l.prototype.commandArgsDialog=function(a,c){var e=document.getElementById("jsroot_cmdargs_dialog");e&&e.parentNode.removeChild(e);e="";for(var d=0;d<c.length;++d)e+='<label for="jsroot_cmdargs_dialog_inp'+d+'">arg'+(d+1)+'</label>\n                    <input type="text" tabindex="0" name="jsroot_cmdargs_dialog_inp'+d+'" id="jsroot_cmdargs_dialog_inp'+d+'" value="'+c[d]+'" style="width:100%;display:block" class="text ui-widget-content ui-corner-all"/>';b(document.body).append('<div id="jsroot_cmdargs_dialog">\n           <form>\n             <fieldset style="padding:0; border:0">\n                '+
