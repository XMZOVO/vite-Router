...
var c=new B(a,b);c.options=d;b=JSROOT.create("TGraphAsymmErrors");b.fName="eff_graph";c.fillGraph(b,d);return JSROOT.draw(a,b,d).then(function(){c.addToPadPrimitives();return c})};g.drawGraphPolargram=function(a,b){var d=g.getElementMainPainter(a);if(d)return d.getObject()===b?d:Promise.reject(Error("Cannot superimpose TGraphPolargram with any other drawings"));var c=new r(a,b);return g.ensureTCanvas(c,!1).then(function(){c.setAsMainPainter();c.redraw();return c})};g.drawASImage=function(a,b,d){var c=
new A(a,b,d);c.decodeOptions(d);return g.ensureTCanvas(c,!1).then(function(){return c.drawImage()}).then(function(){c.fillToolbar();return c})};g.drawRatioPlot=function(a,b,d){var c=new D(a,b,d);return g.ensureTCanvas(c,!1).then(function(){return c.redraw()})};JSROOT.TF1Painter=u;JSROOT.TGraphPainter=m;JSROOT.TGraphPolarPainter=v;JSROOT.TMultiGraphPainter=x;JSROOT.TSplinePainter=t;JSROOT.TASImagePainter=A;JSROOT.TRatioPlotPainter=D;return JSROOT});
