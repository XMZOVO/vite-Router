...
Math.max(Math.abs(c.major[0]),Math.abs(c.major[c.major.length-1]));var r=Math.min(Math.abs(c.major[0]),Math.abs(c.major[c.major.length-1])),p=0<b?3*Math.round(Math.log10(b)/3):0,e=0<r?3*Math.round(Math.log10(r)/3):0;g=2E4>b;if(b||r)a=Math.max(p,e)+3,l=Math.min(p,e)-3}b=0;r=this.ndig;for(p=1E10;l<=a;l+=3)if(!g||3!==l){this.order=l;this.ndig=0;e=[];for(var f=0,h=0;f<c.major.length;){var B=this.format(c.major[f],!0);if(0>e.indexOf(B))e.push(B),h+=B.length,f++;else{if(15<++this.ndig)break;e=[];h=f=0}}!l&&
4>this.ndig&&(h-=2*c.major.length+3);h<p&&(p=h,b=this.order,r=this.ndig)}this.order=b;this.ndig=r;d&&(this.order&&console.warn("Axis painter - integer labels are configured, but axis order "+this.order+" is preferable"),this.ndig&&console.warn("Axis painter - integer labels are configured, but "+this.ndig+" decimal digits are required"),this.order=this.ndig=0)}return c};n.prototype.isCenteredLabels=function(){if("labels"===this.kind)return!0;if(this.log)return!1;var a=this.getObject();return a&&a.TestBit(JSROOT.EAxisBits.kCenterLabels)};
n.prototype.addTitleDrag=function(a,b,c,d,g){var l=this;if(JSROOT.settings.MoveResize&&!JSROOT.batch_mode){var r=null,p,e,f,k,B,q,t,m=h.drag().subject(Object);m.on("start",function(c){c.sourceEvent.preventDefault();c.sourceEvent.stopPropagation();c=a.node().getBBox();var P=l.getObject(),A=b?c.height:c.width,h=P.TestBit(JSROOT.EAxisBits.kOppositeTitle);f=p=a.property("shift_x");k=e=a.property("shift_y");B=b?0<p:0<e;q=b?[g,g/2,0]:[0,g/2,g];A=b?-A/2:A/2;"middle"==l.title_align?(q[0]+=A,q[2]-=A):"begin"==
l.title_align?(q[1]-=A,q[2]-=2*A):(q[0]+=2*A,q[1]+=A);t=P.TestBit(JSROOT.EAxisBits.kCenterTitle)?1:d^h?0:2;q[t]=b?e:p;r=a.append("rect").classed("zoom",!0).attr("x",c.x).attr("y",c.y).attr("width",c.width).attr("height",c.height).style("cursor","move")}).on("drag",function(c){if(r){c.sourceEvent.preventDefault();c.sourceEvent.stopPropagation();p+=c.dx;e+=c.dy;var d;var g=b?e:p;c=0;for(d=1;3>d;++d)Math.abs(g-q[d])<Math.abs(g-q[c])&&(c=d);b?(g=p,d=q[c]):(d=e,g=q[c]);B===(b?0<g:0<d)&&(f=g,k=d,t=c,a.attr("transform",
"translate("+f+","+k+")"))}}).on("end",function(d){if(r){d.sourceEvent.preventDefault();d.sourceEvent.stopPropagation();a.property("shift_x",f).property("shift_y",k);var g=l.getObject();d=JSROOT.EAxisBits;var p=function(a,b){g.TestBit(a)!=b&&g.InvertBit(a)};g.fTitleOffset=(b?f:k)/c;1==t?(p(d.kCenterTitle,!0),p(d.kOppositeTitle,!1)):0==t?(p(d.kCenterTitle,!1),p(d.kOppositeTitle,!0)):(p(d.kCenterTitle,!1),p(d.kOppositeTitle,!1));r.remove();r=null}});a.style("cursor","move").call(m)}};n.prototype.drawTicks=
function(a,b,c,d,g,l,r){var p="",e="",f=0,h=0;for(this.ticks=[];b.next(!0);){var k=Math.round(d/4);3>b.kind&&(k=Math.round(d/2));1==b.kind&&(null!==this.format(b.tick,!0)&&(k=d),this.ticks.push(b.grpos));if(0<g)var q=-k;else 0>c?(q=-k,k=0):q=0;0==p.length?(p=this.vertical?"M"+k+","+b.grpos:"M"+b.grpos+","+-k,e=this.vertical?"M"+(l-k)+","+b.grpos:"M"+b.grpos+","+(l+k)):(p+=this.vertical?"m"+(k-h)+","+(b.grpos-f):"m"+(b.grpos-f)+","+(h-k),e+=this.vertical?"m"+(h-k)+","+(b.grpos-f):"m"+(b.grpos-f)+","+
(k-h));p+=this.vertical?"h"+(q-k):"v"+(k-q);e+=this.vertical?"h"+(k-q):"v"+(q-k);f=b.grpos;h=q}0<p.length&&r&&a.append("svg:path").attr("d",p).call(this.lineatt.func);0!==l&&0<e.length&&r&&a.append("svg:path").attr("d",e).call(this.lineatt.func)};n.prototype.findLabelModifier=function(a,b,c){if(!a.fModLabs)return null;for(var d=0;d<a.fModLabs.arr.length;++d){var g=a.fModLabs.arr[d];if(g.fLabNum===b+1||0>g.fLabNum&&b===c+g.fLabNum)return g}return null};n.prototype.drawLabels=function(a,b,c,d,g,l,e,
p,f,P,k){function r(a){var b=this.result_width;G=Math.max(G,b);if(b&&(!a.vertical&&!m||a.vertical&&m)&&!a.log){var c=.45*this.gap_before+.45*this.gap_after;this.gap_before?this.gap_after||(c=.9*this.gap_before):c=.9*this.gap_after;n=Math.min(n,c/b)}else a.vertical&&k&&this.normal_side&&20<k-p&&b>k-p&&(n=Math.min(n,(k-p)/b));.01<n&&.7>n&&!a.vertical&&!m&&5<u&&1==w.length&&(C=!0);b=n*(C?3:1);.01<b&&1>b&&(x=1/b,a.scaleTextDrawing(x,w[0]))}var A=this,t=this.getColor(b.fLabelColor),R=this.isCenteredLabels(),
m=b.TestBit(JSROOT.EAxisBits.kLabelsVert),n=1,u=0,x=0,w=[a.append("svg:g").attr("class","axis_labels")];g=g.lbl_pos||g.major;var C=!1,G=0;this.lbls_both_sides&&w.push(a.append("svg:g").attr("class","axis_labels").attr("transform",this.vertical?"translate("+c+",0)":"translate(0,"+-d+")"));var z=new JSROOT.FontHandler(b.fLabelFont,e);for(a=0;a<w.length;++a){0<a&&(l=-l);var J=0,E=this.vertical?-p*l:(p+2)*l+P*f;this.startTextDrawing(z,"font",w[a]);for(var F=0;F<g.length;++F){var N=this.format(g[F],!0);
if(null!==N){var D=this.findLabelModifier(b,F,g.length);if(!D||0!=D.fTextSize){D&&D.fLabText&&(N=D.fLabText);var v={text:N,color:t,latex:1,draw_g:w[a],normal_side:0==a},y=Math.round(this.func(g[F]));D&&0<D.fTextColor&&(v.color=this.getColor(D.fTextColor));v.gap_before=0<F?Math.abs(Math.round(y-this.func(g[F-1]))):0;v.gap_after=F<g.length-1?Math.abs(Math.round(this.func(g[F+1])-y)):0;if(R&&(D=v.gap_after||v.gap_before,y=Math.round(y-(this.vertical?.5*D:-.5*D)),-5>y||y>(this.vertical?d:c)+5))continue;
u=Math.max(u,N.length);this.vertical?(v.x=E,v.y=y,v.align=m?0>l?23:20:0>l?12:32):(v.x=y,v.y=E,v.align=m?0>l?12:32:0>l?20:23);m&&(v.rotate=270);0==a&&(v.post_process=r);this.drawText(v);J&&y!=J&&(this.vertical&&!m||!this.vertical&&m)&&(n=Math.min(n,.9*Math.abs(y-J)/e));J=y}}}this.order&&this.drawText({color:t,x:this.vertical?5*l:c+5,y:this.has_obstacle?E:this.vertical?-3:-3*l,align:this.vertical?0>l?30:10:this.has_obstacle^0>l?13:10,latex:1,text:"#times"+this.formatExp(10,this.order),draw_g:w[a]})}return this.finishTextDrawing(w[0]).then(function(){return 1<
w.length?(x&&A.scaleTextDrawing(x,w[1]),A.finishTextDrawing(w[1])):!0}).then(function(){C&&w[0].selectAll("text").each(function(){var a=h.select(this),b=a.attr("transform");a.attr("transform",b+" rotate(25)").style("text-anchor","start")});z&&(e=z.size);return[e,G]})};n.prototype.drawAxis=function(a,b,c,d,g,l,e,p){var r=this,f=this.getObject(),h="",k=f&&"TGaxis"===f._typename,q=a,t=.03,m,n=!0,u=(m=this.getPadPainter())?m.getPadWidth():10,z=m?m.getPadHeight():10,x=this.vertical,w=this.swap_side||!1;
g?this.invert_side&&(g=-g):g=0;k?(this.createAttLine({attr:f}),n=0!=f.fLineColor,h=f.fChopt,t=f.fTickSize,m=x?1.7*c:.6*b):(this.createAttLine({color:f.fAxisColor,width:1,style:1}),h=x^this.invert_side?"-S":"+S",t=f.fTickLength,m=x?u:z);this.lineatt.not_standard=!0;k&&"zaxis"!==this.name||(q=a.select("."+this.name+"_container"),q.empty()?q=a.append("svg:g").attr("class",this.name+"_container"):q.selectAll("*").remove());!l&&n&&q.append("svg:path").attr("d","M0,0"+(x?"v"+c:"h"+b)).call(this.lineatt.func);
q.attr("transform",d||null);var C=1;a=0;var G=Math.min(u,z),E=0<=h.indexOf("+"),J=0<=h.indexOf("-"),L=0<=h.indexOf("S");d=0<=h.indexOf("U")||this.optionUnlab;var F=0<=h.indexOf("N");h=0<=h.indexOf("I");var N=f.TestBit(JSROOT.EAxisBits.kNoExponent);0>=G&&(G=1E-4);k&&f.TestBit(JSROOT.EAxisBits.kTickPlus)&&(E=!0);k&&f.TestBit(JSROOT.EAxisBits.kTickMinus)&&(J=!0);E&&J?a=C=1:J?C=w^x?1:-1:E&&(C=w^x?-1:1);t=Math.round((L?t:.03)*m);this.max_tick_size&&t>this.max_tick_size&&(t=this.max_tick_size);m=this.createTicks(!1,
N,F,h);this.drawTicks(q,m,C,t,a,g,n&&!l&&!this.disable_ticks);g=Math.round(1>f.fLabelSize?f.fLabelSize*G:f.fLabelSize);var D=Math.round(Math.abs(f.fLabelOffset)*G);if(0>=g||1.1<Math.abs(f.fLabelOffset))d=!0;var v=0,y=0,I=null,M=null,O=0,K=0;return(l||d?Promise.resolve([g,0]):this.drawLabels(q,f,b,c,m,C,g,D,t,a,e)).then(function(a){K=a[1];if(JSROOT.settings.Zooming&&!r.disable_zooming&&!JSROOT.batch_mode){var d=a[0];a=q.append("svg:rect").attr("class","axis_zoom").style("opacity","0").style("cursor",
"crosshair");x?(d=(K||2*d)+3,a.attr("x",0<C?-d:0).attr("y",0).attr("width",d).attr("height",c)):a.attr("x",0).attr("y",0<C?0:-d-3).attr("width",b).attr("height",d+3)}r.position=0;if(p){a=q.node();d=r.getPadSvg().node();if(a&&d&&a.getBoundingClientRect&&d.getBoundingClientRect){var g=a.getBoundingClientRect(),e=d.getBoundingClientRect();r.position=g.left-e.left}a&&!d&&console.warn("Why PAD element missing when search for position")}if(!f.fTitle||l)return!0;I=q.append("svg:g").attr("class","axis_title");
O=1<=f.fTitleSize?f.fTitleSize:Math.round(f.fTitleSize*G);a=1.6*(1>f.fTitleSize?f.fTitleSize:f.fTitleSize/(G||10));d=f.TestBit(JSROOT.EAxisBits.kCenterTitle);var h=f.TestBit(JSROOT.EAxisBits.kOppositeTitle);g=f.TestBit(JSROOT.EAxisBits.kRotateTitle)?-1:1;e=r.getColor(k?f.fTextColor:f.fTitleColor);r.startTextDrawing(f.fTitleFont,O,I);h^=w;r.title_align=d?"middle":0>g^h?"begin":"end";if(x){a*=-C*u;v=Math.round(a*f.fTitleOffset);if("zaxis"==r.name&&k&&"getBoundingClientRect"in q.node()){var A=q.node().getBoundingClientRect();
v<A.width-t&&(v=Math.round(A.width-t))}y=Math.round(d?c/2:h?c:0);r.drawText({align:r.title_align+";middle",rotate:0>g?90:270,text:f.fTitle,color:e,draw_g:I})}else a*=C*z,v=Math.round(d?b/2:h?0:b),y=Math.round(a*f.fTitleOffset),r.drawText({align:r.title_align+";middle",rotate:0>g?180:0,text:f.fTitle,color:e,draw_g:I});x&&0==f.fTitleOffset&&"getBoundingClientRect"in q.node()&&(M=q.node().getBoundingClientRect());r.addTitleDrag(I,x,a,w,x?c:b);return r.finishTextDrawing(I)}).then(function(){if(I){if(M){var a=
I.node().getBoundingClientRect();v=M.left!=M.right&&a.left!=a.right?0<C?Math.round(M.left-a.right-.3*O):Math.round(M.right-a.left+.3*O):-1*Math.round((0<C?D+K:0)+.7*O)}I.attr("transform","translate("+v+","+y+")").property("shift_x",v).property("shift_y",y)}return r})};n.prototype.convertTo=function(a){var b=this.getObject(),c=this.axisToSvg("x",b.fX1),d=this.axisToSvg("y",b.fY1),g=this.axisToSvg("x",b.fX2),l=this.axisToSvg("y",b.fY2);if("ndc"==a){a=this.getPadPainter().getPadWidth();var f=this.getPadPainter().getPadHeight();
...
k.prototype.getProjectionFunc=function(){switch(this.projection){case 1:return K;case 2:return V;case 3:return u;case 4:return E}};k.prototype.recalculateRange=function(a){this.projection=a||0;2==this.projection&&(-90>=this.scale_ymin||90<=this.scale_ymax)&&(console.warn("Mercator Projection","Latitude out of range",this.scale_ymin,this.scale_ymax),this.projection=0);var b=this.getProjectionFunc();if(b)for(a=[b(this.scale_xmin,this.scale_ymin),b(this.scale_xmin,this.scale_ymax),b(this.scale_xmax,
...
k.prototype.axisAsText=function(a,b){var c=this[a+"_handle"];return c?c.axisAsText(b,JSROOT.settings[a.toUpperCase()+"ValuesFormat"]):b.toPrecision(4)};k.prototype.hasDrawnAxes=function(a,b){return a||b?!1:this.axes_drawn};k.prototype.drawAxes=function(a,b,c,d,g){var l=this;this.cleanAxesDrawings();if(this.xmin==this.xmax||this.ymin==this.ymax)return Promise.resolve(!1);void 0===d&&(d=0);var f=this.getFrameSvg().select(".axis_layer"),e=this.getFrameWidth(),h=this.getFrameHeight(),k=this.getPadPainter().getRootPad(!0);
this.x_handle.invert_side=10<=d;this.x_handle.lbls_both_sides=!this.x_handle.invert_side&&k&&1<k.fTickx;this.x_handle.has_obstacle=g;this.y_handle.invert_side=1===d%10;this.y_handle.lbls_both_sides=!this.y_handle.invert_side&&k&&1<k.fTicky;d=this.swap_xy?this.y_handle:this.x_handle;var m=this.swap_xy?this.x_handle:this.y_handle;b&&c||(g=this.getPadPainter())&&g._fast_drawing&&(b=c=!0);if(b&&c)c=Promise.resolve(!0);else{var n=!a&&JSROOT.settings.CanAdjustFrame;b=d.drawAxis(f,e,h,d.invert_side?void 0:
"translate(0,"+h+")",k&&k.fTickx?-h:0,b,void 0,!1);c=m.drawAxis(f,e,h,m.invert_side?"translate("+e+",0)":void 0,k&&k.fTicky?e:0,c,m.invert_side?0:this._frame_x,n);c=Promise.all([b,c]).then(function(){l.drawGrids();if(n){var a=0,b=m.position;-.2*e<b&&0>b?(a=-b/e+.001,l.shrink_frame_left+=a):0<b&&b<.3*e&&0<l.shrink_frame_left&&b/e>l.shrink_frame_left&&(a=-l.shrink_frame_left,l.shrink_frame_left=0);if(0!=a)return l.shrinkFrame(a,0),l.redraw(),l.drawAxes(!0)}})}return c.then(function(){a||(l.axes_drawn=
...
a?(d=c,c=b,a=b=void 0):"z"===a&&(g=b,l=c,a=b=c=void 0);var f=a!==b,h=c!==d,k=g!==l,m=!1,n=!1,q=!1;if(f){var t=0;a<=this.xmin&&(a=this.xmin,t++);b>=this.xmax&&(b=this.xmax,t++);2===t&&(f=!1,m=!0)}else m=a===b&&0===a;h?(t=0,c<=this.ymin&&(c=this.ymin,t++),d>=this.ymax&&(d=this.ymax,t++),2===t&&(h=!1,n=!0)):n=c===d&&0===c;k?(t=0,g<=this.zmin&&(g=this.zmin,t++),l>=this.zmax&&(l=this.zmax,t++),2===t&&(k=!1,q=!0)):q=g===l&&0===g;var H=!1;(f||h||k)&&this.forEachPainter(function(p){"function"==typeof p.canZoomInside&&
(f&&p.canZoomInside("x",a,b)&&(e.zoom_xmin=a,e.zoom_xmax=b,H=!0,f=!1),h&&p.canZoomInside("y",c,d)&&(e.zoom_ymin=c,e.zoom_ymax=d,H=!0,h=!1),k&&p.canZoomInside("z",g,l)&&(e.zoom_zmin=g,e.zoom_zmax=l,H=!0,k=!1))});if(m||n||q)m&&(this.zoom_xmin!==this.zoom_xmax&&(H=!0),this.zoom_xmin=this.zoom_xmax=0),n&&(this.zoom_ymin!==this.zoom_ymax&&(H=!0),this.zoom_ymin=this.zoom_ymax=0),q&&(this.zoom_zmin!==this.zoom_zmax&&(H=!0),this.zoom_zmin=this.zoom_zmax=0),H||(t=this.getPadPainter())&&t.painters&&t.painters.forEach(function(a){a&&
"function"==typeof a.unzoomUserRange&&a.unzoomUserRange(m,n,q)&&(H=!0)});return H?this.interactiveRedraw("pad","zoom").then(function(){return!0}):Promise.resolve(!1)};k.prototype.zoomSingle=function(a,b,c){var d=this;if(this.projection||!this[a+"_handle"])return Promise.resolve(!1);var g=b!==c,e=!1;if(g){var f=0;b<=this[a+"min"]&&(b=this[a+"min"],f++);c>=this[a+"max"]&&(c=this[a+"max"],f++);2===f&&(g=!1,e=!0)}else e=b===c&&0===b;var h=!1;g&&this.forEachPainter(function(e){"function"==typeof e.canZoomInside&&
...
this.checkResize(!0);this._fast_drawing!=a&&this.showPadButtons()};e.prototype.createPadSvg=function(a){var b=this;if(!this.has_canvas)return this.createCanvasSvg(a?2:0),!0;var c=this.getCanvSvg(),d=c.property("draw_width"),g=c.property("draw_height"),e=c.property("pad_enlarged"),f=!this.pad_draw_disabled&&(!e||e===this.pad),h=Math.round(this.pad.fAbsWNDC*d),k=Math.round(this.pad.fAbsHNDC*g),m=Math.round(this.pad.fAbsXlowNDC*d),n=Math.round(g*(1-this.pad.fAbsYlowNDC))-k,B=null,q=null,t=null;e===this.pad&&
(h=d,k=g,m=n=0);if(a)B=this.svg_this_pad(),q=B.select(".root_pad_border"),JSROOT.batch_mode||(t=this.getLayerSvg("btns_layer",this.this_pad_name));else{B=c.select(".primitives_layer").append("svg:svg").classed("__root_pad_"+this.this_pad_name,!0).attr("pad",this.this_pad_name).property("pad_painter",this);q=B.append("svg:path").attr("class","root_pad_border");B.append("svg:g").attr("class","primitives_layer");JSROOT.batch_mode||(t=B.append("svg:g").attr("class","btns_layer").property("leftside","left"!=
JSROOT.settings.ToolBarSide).property("vertical",JSROOT.settings.ToolBarVert));if(JSROOT.settings.ContextMenu)q.on("contextmenu",function(a){return b.padContextMenu(a)});if(!JSROOT.batch_mode)q.attr("pointer-events","visibleFill").on("dblclick",function(a){return b.enlargePad(a)}).on("click",function(){return b.selectObjectPainter()}).on("mouseenter",function(){return b.showObjectStatus()})}this.createAttFill({attr:this.pad});this.createAttLine({attr:this.pad,color0:0==this.pad.fBorderMode?"none":
""});B.attr("display",f?null:"none").attr("viewBox","0 0 "+h+" "+k).attr("preserveAspectRatio","none").attr("x",m).attr("y",n).attr("width",h).attr("height",k).property("draw_x",m).property("draw_y",n).property("draw_width",h).property("draw_height",k);this._pad_x=m;this._pad_y=n;this._pad_width=h;this._pad_height=k;q.attr("d","M0,0H"+h+"V"+k+"H0Z").call(this.fillatt.func).call(this.lineatt.func);this.drawActiveBorder(q);this._fast_drawing=JSROOT.settings.SmallPad&&(h<JSROOT.settings.SmallPad.width||
k<JSROOT.settings.SmallPad.height);B.property("can3d")===JSROOT.constants.Embed3D.Overlay&&this.selectDom().select(".draw3d_"+this.this_pad_name).style("display",f?"":"none");this.alignButtons&&t&&this.alignButtons(t,h,k);return f};e.prototype.disablePadDrawing=function(){this.pad_draw_disabled||!this.has_canvas||this.iscan||(this.pad_draw_disabled=!0,this.createPadSvg(!0))};e.prototype.checkSpecial=function(a){if(!a)return!1;if("TStyle"==a._typename)return JSROOT.extend(JSROOT.gStyle,a),!0;if("TObjArray"==
...
d.node().innerHTML+"</svg>";f.processSvgWorkarounds&&(n=f.processSvgWorkarounds(n));n=f.compressSVG(n);if("svg"==b)return k(),Promise.resolve(n);var u=new Image;return new Promise(function(a){u.onload=function(){var c=document.createElement("canvas");c.width=u.width;c.height=u.height;c.getContext("2d").drawImage(u,0,0);k();a(c.toDataURL("image/"+b))};u.onerror=function(b){console.log("IMAGE ERROR",b);k();a(null)};u.src="data:image/svg+xml;base64,"+window.btoa(h('<?xml version="1.0" standalone="no"?><!DOCTYPE svg PUBLIC "-//W3C//DTD SVG 1.1//EN" "http://www.w3.org/Graphics/SVG/1.1/DTD/svg11.dtd">'+
...
break;case "Editor":return this.activateGed(this,null,!!b);case "ToolTips":this.setTooltipAllowed(b)}return Promise.resolve(!0)};m.prototype.completeCanvasSnapDrawing=function(){this.pad&&(document&&!this.embed_canvas&&this._websocket&&(document.title=this.pad.fTitle),this._all_sections_showed||(this._all_sections_showed=!0,this.showSection("Menu",this.pad.TestBit(z)),this.showSection("StatusBar",this.pad.TestBit(T)),this.showSection("ToolBar",this.pad.TestBit(W)),this.showSection("Editor",this.pad.TestBit(S)),
this.showSection("ToolTips",this.pad.TestBit(L))))};m.prototype.processChanges=function(a,b,c){if(this._websocket&&!this._readonly&&this._websocket.canSend(2)&&"string"===typeof a){var d="";b||(b=this);switch(a){case "sbits":d="STATUSBITS:"+this.getStatusBits();break;case "frame":case "zoom":b.getWebPadOptions||(b=b.getPadPainter());"function"==typeof b.getWebPadOptions&&(d="OPTIONS6:"+b.getWebPadOptions("only_this"));break;case "pave_moved":b.fillWebObjectOptions&&(a=b.fillWebObjectOptions())&&(d=
...
padid:a.snapid.toString(),objid:"",x:-1,y:-1,dbl:!1});a.is_active_pad||(e=!0,this.forEachPainterInPad(function(b){return b.drawActiveBorder(null,b===a)},"pads"));b&&void 0!==b.snapid&&d&&(e=!0,d.objid=b.snapid.toString());c&&d&&(e=!0,d.x=Math.round(c.x||0),d.y=Math.round(c.y||0),c.dbl&&(d.dbl=!0));d&&e&&this.sendWebsocket("PADCLICKED:"+JSROOT.toJSON(d))}};m.prototype.getStatusBits=function(){var a=0;this.hasEventStatus()&&(a|=T);this.hasGed()&&(a|=S);this.isTooltipAllowed()&&(a|=L);this.use_openui&&
(a|=z);return a};m.prototype.produceJSON=function(){var a=this.getObject(),b=0==a.fFillStyle;b&&(a.fFillStyle=1001);this.normal_canvas||this.forEachPainterInPad(function(b){if(!b.$secondary){var c=b.getObject();c&&c._typename&&a.fPrimitives.Add(c,b.getDrawOpt())}},"objects");var c=JSROOT.toJSON(a);b&&(a.fFillStyle=0);this.normal_canvas||a.fPrimitives.Clear();return c};m.prototype.directGeoDraw=function(){var a=this.pad?this.pad.fPrimitives:null;if(a&&1==a.arr.length&&a.arr[0]&&a.arr[0]._typename&&
0==a.arr[0]._typename.indexOf("TGeo"))return JSROOT.draw(this.getDom(),a.arr[0],a.opt[0])};var U=function(a,b,c){var d=!b;d&&(b=JSROOT.create("TCanvas"));var e=new m(a,b);e.checkSpecialsInPrimitives(b);if(!d&&b.fCw&&b.fCh&&!JSROOT.batch_mode){var h=e.selectDom().node().getBoundingClientRect();!h.height&&h.width>.1*b.fCw&&(e.selectDom().style("width",b.fCw+"px").style("height",b.fCh+"px"),e._fixed_size=!0)}if(b=e.directGeoDraw())return b;e.decodeOptions(c);e.normal_canvas=!d;e.createCanvasSvg(0);e.addPadButtons();
return(d&&0>c.indexOf("noframe")?Q(a,null):Promise.resolve(!0)).then(function(){f.selectActivePad({pp:e,active:!0});return e.drawPrimitives()}).then(function(){e.showPadButtons();return e})};JSROOT.TAxisPainter=n;JSROOT.TFramePainter=k;JSROOT.TPadPainter=e;JSROOT.TCanvasPainter=m;f.drawGaxis=function(a,b,c){var d=new n(a,b,!1);d.disable_zooming=!0;return f.ensureTCanvas(d,!1).then(function(){c&&d.convertTo(c);return d.redraw()})};f.drawFrame=Q;f.drawPad=function(a,b,c){var d=new e(a,b,!1);d.decodeOptions(c);
d.getCanvSvg().empty()?(d.has_canvas=!1,d.this_pad_name="",d.setTopPainter()):d.addToPadPrimitives(d.pad_name);d.createPadSvg();!d.matchObjectType("TPad")||d.has_canvas&&!d.hasObjectsToDraw()||d.addPadButtons();var g=d.has_canvas?d.selectCurrentPad(d.this_pad_name):void 0;f.selectActivePad({pp:d,active:!0});return d.drawPrimitives().then(function(){d.showPadButtons();d.selectCurrentPad(g);return d})};f.drawCanvas=U;f.ensureTCanvas=function(a,b){if(!a)return Promise.reject("Painter not provided in ensureTCanvas");
var c=a.getCanvSvg(),d=!1===b||"3d"==b?"noframe":"";return(c.empty()?U(a.getDom(),null,d):Promise.resolve(!0)).then(function(){if(!1!==b&&a.getFrameSvg().select(".main_layer").empty()&&!a.getFramePainter())return Q(a.getDom(),null,"string"===typeof b?b:"")}).then(function(){a.addToPadPrimitives();return a})};f.drawPadSnapshot=function(a,b){var c=JSROOT.create("TCanvas"),d=new m(a,c);d.normal_canvas=!1;d.addPadButtons();return d.syncDraw(!0).then(function(){return d.redrawPadSnap(b)}).then(function(){d.confirmDraw();
